(ns editor.views
  (:require
   [reagent.core :as r]
   [editor.sci :refer [update-editor! !view update-editor!]]
   [editor.sci-editor :as sci-editor]
...
(defn main-panel []
  [:div
   [sci-editor/editor "" @!view {:eval?    true
                                 :visible? true}]]
  (when @key-bindings?
    [key-bindings-table (merge keymap/paredit-keymap* (editor.sci/keymap* "Alt"))]))