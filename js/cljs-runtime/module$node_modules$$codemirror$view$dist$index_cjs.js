...
function scrollRectIntoView(dom,rect$jscomp$0,side,x,y,xMargin,yMargin,ltr){let doc=dom.ownerDocument,win=doc.defaultView;for(;dom;)if(1==dom.nodeType){let top=dom==doc.body;if(top){var JSCompiler_object_inline_left_3114=0;var JSCompiler_object_inline_right_3115=win.innerWidth;var JSCompiler_object_inline_top_3116=0;var JSCompiler_object_inline_bottom_3117=win.innerHeight}else{if(dom.scrollHeight<=dom.clientHeight&&dom.scrollWidth<=dom.clientWidth){dom=dom.parentNode;continue}var rect=dom.getBoundingClientRect();
JSCompiler_object_inline_left_3114=rect.left;JSCompiler_object_inline_right_3115=rect.left+dom.clientWidth;JSCompiler_object_inline_top_3116=rect.top;JSCompiler_object_inline_bottom_3117=rect.top+dom.clientHeight}var moveY=rect=0;"nearest"==y?rect$jscomp$0.top<JSCompiler_object_inline_top_3116?(moveY=-(JSCompiler_object_inline_top_3116-rect$jscomp$0.top+yMargin),0<side&&rect$jscomp$0.bottom>JSCompiler_object_inline_bottom_3117+moveY&&(moveY=rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_3117+
moveY+yMargin)):rect$jscomp$0.bottom>JSCompiler_object_inline_bottom_3117&&(moveY=rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_3117+yMargin,0>side&&rect$jscomp$0.top-moveY<JSCompiler_object_inline_top_3116&&(moveY=-(JSCompiler_object_inline_top_3116+moveY-rect$jscomp$0.top+yMargin))):(moveY=rect$jscomp$0.bottom-rect$jscomp$0.top,JSCompiler_object_inline_bottom_3117-=JSCompiler_object_inline_top_3116,moveY=("center"==y&&moveY<=JSCompiler_object_inline_bottom_3117?rect$jscomp$0.top+moveY/2-
JSCompiler_object_inline_bottom_3117/2:"start"==y||"center"==y&&0>side?rect$jscomp$0.top-yMargin:rect$jscomp$0.bottom-JSCompiler_object_inline_bottom_3117+yMargin)-JSCompiler_object_inline_top_3116);"nearest"==x?rect$jscomp$0.left<JSCompiler_object_inline_left_3114?(rect=-(JSCompiler_object_inline_left_3114-rect$jscomp$0.left+xMargin),0<side&&rect$jscomp$0.right>JSCompiler_object_inline_right_3115+rect&&(rect=rect$jscomp$0.right-JSCompiler_object_inline_right_3115+rect+xMargin)):rect$jscomp$0.right>
JSCompiler_object_inline_right_3115&&(rect=rect$jscomp$0.right-JSCompiler_object_inline_right_3115+xMargin,0>side&&rect$jscomp$0.left<JSCompiler_object_inline_left_3114+rect&&(rect=-(JSCompiler_object_inline_left_3114+rect-rect$jscomp$0.left+xMargin))):rect=("center"==x?rect$jscomp$0.left+(rect$jscomp$0.right-rect$jscomp$0.left)/2-(JSCompiler_object_inline_right_3115-JSCompiler_object_inline_left_3114)/2:"start"==x==ltr?rect$jscomp$0.left-xMargin:rect$jscomp$0.right-(JSCompiler_object_inline_right_3115-
JSCompiler_object_inline_left_3114)+xMargin)-JSCompiler_object_inline_left_3114;if(rect||moveY)top?win.scrollBy(rect,moveY):(moveY&&(x=dom.scrollTop,dom.scrollTop+=moveY,moveY=dom.scrollTop-x),rect&&(x=dom.scrollLeft,dom.scrollLeft+=rect,rect=dom.scrollLeft-x),rect$jscomp$0={left:rect$jscomp$0.left-rect,top:rect$jscomp$0.top-moveY,right:rect$jscomp$0.right-rect,bottom:rect$jscomp$0.bottom-moveY});if(top)break;dom=dom.assignedSlot||dom.parentNode;x=y="nearest"}else if(11==dom.nodeType)dom=dom.host;
...
contains(child.dom,text),len=hasComp?text.nodeValue.length:child.length;if(pos<len||pos==len&&0>=child.getSide())return hasComp?scanCompositionTree(pos,side,child,text,enterView,fromText):enterView(child,pos,side);pos-=len}return enterView(view,view.length,-1)}return view.dom==text?fromText(pos,side):enterView(view,pos,side)}function posFromDOMInCompositionTree(node,offset,view,text){if(view instanceof MarkView)for(let child of view.children){let hasComp=contains(child.dom,text);if(contains(child.dom,
node))return 0+(hasComp?posFromDOMInCompositionTree(node,offset,child,text):child.localPosFromDOM(node,offset))}else if(view.dom==text)return Math.min(offset,text.nodeValue.length);return view.localPosFromDOM(node,offset)}function inlineDOMAtPos(dom,children,pos){let i=0;for(let off=0;i<children.length;i++){let child=children[i],end=off+child.length;if(!(end==off&&0>=child.getSide())){if(pos>off&&pos<end&&child.dom.parentNode==dom)return child.domAtPos(pos-off);if(pos<=off)break;off=end}}for(;0<i;i--)if(pos=
children[i-1].dom,pos.parentNode==dom)return DOMPos.after(pos);return new DOMPos(dom,0)}function joinInlineInto(parent,view,open){let last,{children}=parent;0<open&&view instanceof MarkView&&children.length&&(last=children[children.length-1])instanceof MarkView&&last.mark.eq(view.mark)?joinInlineInto(last,view.children[0],open-1):(children.push(view),view.setParent(parent));parent.length+=view.length}function coordsInChildren(view,pos,side){for(let off=0,i=0;i<view.children.length;i++){let child=
view.children[i],end=off+child.length,next;if((0>=side||end==view.length||0<child.getSide()?end>=pos:end>pos)&&(pos<end||i+1==view.children.length||(next=view.children[i+1]).length||0<next.getSide())){let flatten=0;if(end==off){if(0>=child.getSide())continue;flatten=side=-child.getSide()}view=child.coordsAt(Math.max(0,pos-off),side);return flatten&&view?flattenRect(view,0>side):view}off=end}side=view.dom.lastChild;if(!side)return view.dom.getBoundingClientRect();view=clientRectsFor(side);return view[view.length-
1]||null}function combineAttrs(source,target){for(let name in source)"class"==name&&target.class?target.class+=" "+source.class:"style"==name&&target.style?target.style+=";"+source.style:target[name]=source[name];return target}function attrsEq(a,b){if(a==b)return!0;if(!a||!b)return!1;let keysA=Object.keys(a),keysB=Object.keys(b);if(keysA.length!=keysB.length)return!1;for(let key of keysA)if(-1==keysB.indexOf(key)||a[key]!==b[key])return!1;return!0}function updateAttrs(dom,prev,attrs){let changed=
null;if(prev)for(let name in prev)attrs&&name in attrs||dom.removeAttribute(changed=name);if(attrs)for(let name in attrs)prev&&prev[name]==attrs[name]||dom.setAttribute(changed=name,attrs[name]);return!!changed}function getInclusive(spec,block=!1){let {inclusiveStart:start,inclusiveEnd:end}=spec;null==start&&(start=spec.inclusive);null==end&&(end=spec.inclusive);return{start:null!==start&&void 0!==start?start:block,end:null!==end&&void 0!==end?end:block}}function addRange(from,to,ranges,margin=0){let last=
...
dir)&&(start=order[spanI+=forward?1:-1],startIndex=start.side(!forward,dir));last=forward==(start.dir==dir);_a=state$jscomp$0.findClusterBreak(line.text,startIndex,last);movedOver=line.text.slice(Math.min(startIndex,_a),Math.max(startIndex,_a));return _a!=start.side(forward,dir)?state$jscomp$0.EditorSelection.cursor(_a+line.from,last?-1:1,start.level):(order=spanI==(forward?order.length-1:0)?null:order[spanI+(forward?1:-1)])||start.level==dir?order&&order.level<start.level?state$jscomp$0.EditorSelection.cursor(order.side(!forward,
...
bottom}:rect}function domPosAtCoords(parent,x,y){let closest,closestRect,closestX;let above,below,aboveRect,belowRect;for(let child=parent.firstChild;child;child=child.nextSibling){let rects=clientRectsFor(child);for(let i=0;i<rects.length;i++){let rect=rects[i];closestRect&&yOverlap(closestRect,rect)&&(rect=upTop(upBot(rect,closestRect.bottom),closestRect.top));let dx=rect.left>x?rect.left-x:Math.max(0,x-rect.right),dy=rect.top>y?rect.top-y:Math.max(0,y-rect.bottom);if(0==dx&&0==dy)return 3==child.nodeType?
domPosInText(child,x,y):domPosAtCoords(child,x,y);if(!closest||closestY>dy||closestY==dy&&closestX>dx){closest=child;closestRect=rect;closestX=dx;var closestY=dy}0==dx?y>rect.bottom&&(!aboveRect||aboveRect.bottom<rect.bottom)?(above=child,aboveRect=rect):y<rect.top&&(!belowRect||belowRect.top>rect.top)&&(below=child,belowRect=rect):aboveRect&&yOverlap(aboveRect,rect)?aboveRect=upBot(aboveRect,rect.bottom):belowRect&&yOverlap(belowRect,rect)&&(belowRect=upTop(belowRect,rect.top))}}aboveRect&&aboveRect.bottom>=
y?(closest=above,closestRect=aboveRect):belowRect&&belowRect.top<=y&&(closest=below,closestRect=belowRect);if(!closest)return{node:parent,offset:0};closestY=Math.max(closestRect.left,Math.min(closestRect.right,x));if(3==closest.nodeType)return domPosInText(closest,closestY,y);if(!closestX&&"true"==closest.contentEditable)return domPosAtCoords(closest,closestY,y);x=Array.prototype.indexOf.call(parent.childNodes,closest)+(x>=(closestRect.left+closestRect.right)/2?1:0);return{node:parent,offset:x}}function domPosInText(node,
x,y){let len=node.nodeValue.length;var closestOffset=-1,closestDY=1E9;let generalSide=0;for(let i=0;i<len;i++){let rects=textRange(node,i,i+1).getClientRects();for(let j=0;j<rects.length;j++){let rect=rects[j];if(rect.top==rect.bottom)continue;generalSide||(generalSide=x-rect.left);let dy=(rect.top>y?rect.top-y:y-rect.bottom)-1;if(rect.left-1<=x&&rect.right+1>=x&&dy<closestDY){closestDY=closestOffset=x>=(rect.left+rect.right)/2;(browser.chrome||browser.gecko)&&textRange(node,i).getBoundingClientRect().left==
rect.right&&(closestDY=!closestOffset);if(0>=dy)return{node,offset:i+(closestDY?1:0)};closestOffset=i+(closestDY?1:0);closestDY=dy}}}return{node,offset:-1<closestOffset?closestOffset:0<generalSide?node.nodeValue.length:0}}function posAtCoords(view,{x,y},precise,bias=-1){var _a,content=view.contentDOM.getBoundingClientRect(),docTop=content.top+view.viewState.paddingTop;let block;var {docHeight}=view.viewState;let yOffset=y-docTop;if(0>yOffset)return 0;if(yOffset>docHeight)return view.state.doc.length;
for(let halfLine=view.defaultLineHeight/2,bounced=!1;;){block=view.elementAtHeight(yOffset);if(block.type==exports.BlockType.Text)break;for(;;){yOffset=0<bias?block.bottom+halfLine:block.top-halfLine;if(0<=yOffset&&yOffset<=docHeight)break;if(bounced)return precise?null:0;bounced=!0;bias=-bias}}y=docTop+yOffset;bias=block.from;if(bias<view.viewport.from)return 0==view.viewport.from?0:precise?null:posAtCoordsImprecise(view,content,block,x,y);if(bias>view.viewport.to)return view.viewport.to==view.state.doc.length?
view.state.doc.length:precise?null:posAtCoordsImprecise(view,content,block,x,y);precise=view.dom.ownerDocument;docHeight=view.root.elementFromPoint?view.root:precise;(docTop=docHeight.elementFromPoint(x,y))&&!view.contentDOM.contains(docTop)&&(docTop=null);docTop||(x=Math.max(content.left+1,Math.min(content.right-1,x)),(docTop=docHeight.elementFromPoint(x,y))&&!view.contentDOM.contains(docTop)&&(docTop=null));var node;content=-1;if(docTop&&0!=(null===(_a=view.docView.nearest(docTop))||void 0===_a?
void 0:_a.isEditable))if(precise.caretPositionFromPoint){var pos=precise.caretPositionFromPoint(x,y);pos&&({offsetNode:node,offset:content}=pos)}else if(precise.caretRangeFromPoint&&(_a=precise.caretRangeFromPoint(x,y))){({startContainer:node,startOffset:content}=_a);if(_a=browser.safari)a:if(_a=x,3!=node.nodeType||content!=(pos=node.nodeValue.length))_a=!1;else{for(precise=node.nextSibling;precise;precise=precise.nextSibling)if(1!=precise.nodeType||"BR"!=precise.nodeName){_a=!1;break a}_a=textRange(node,
pos-1,pos).getBoundingClientRect().left>_a}_a&&(node=void 0)}if(!node||!view.docView.dom.contains(node)){node=LineView.find(view.docView,bias);if(!node)return yOffset>block.top+block.height/2?block.to:block.from;({node,offset:content}=domPosAtCoords(node.dom,x,y))}return view.docView.posFromDOM(node,content)}function posAtCoordsImprecise(view,contentRect,block,x,y){contentRect=Math.round((x-contentRect.left)*view.defaultCharacterWidth);view.lineWrapping&&block.height>1.5*view.defaultLineHeight&&(contentRect+=
Math.floor((y-block.top)/view.defaultLineHeight)*view.viewState.heightOracle.lineLength);y=view.state.sliceDoc(block.from,block.to);return block.from+state$jscomp$0.findColumn(y,contentRect,view.state.tabSize)}function moveByChar(view,start,forward,by){let line=view.state.doc.lineAt(start.head),spans=view.bidiSpans(line),direction=view.textDirectionAt(line.from);for(let cur=start,check=null;;){start=moveVisually(line,spans,direction,cur,forward);let char=movedOver;if(!start){if(line.number==(forward?
view.state.doc.lines:1))return cur;char="\n";line=view.state.doc.line(line.number+(forward?1:-1));spans=view.bidiSpans(line);start=state$jscomp$0.EditorSelection.cursor(forward?line.from:line.to)}if(!check){if(!by)return start;check=by(char)}else if(!check(char))return cur;cur=start}}function byGroup(view,pos,start){let categorize=view.state.charCategorizer(pos),cat=categorize(start);return next=>{next=categorize(next);cat==state$jscomp$0.CharCategory.Space&&(cat=next);return cat==next}}function skipAtoms(view,
oldPos,pos){let atoms=view.state.facet(atomicRanges).map(f=>f(view));for(;;){let moved=!1;for(let set of atoms)set.between(pos.from-1,pos.from+1,(from,to,value)=>{pos.from>from&&pos.from<to&&(pos=oldPos.from>pos.from?state$jscomp$0.EditorSelection.cursor(from,1):state$jscomp$0.EditorSelection.cursor(to,-1),moved=!0)});if(!moved)return pos}}function isInPrimarySelection(view,event){var {main}=view.state.selection;if(main.empty)return!1;view=getSelection(view.root);if(!view||0==view.rangeCount)return!0;
...
function capturePaste(view){let parent=view.dom.parentNode;if(parent){var target=parent.appendChild(document.createElement("textarea"));target.style.cssText="position: fixed; left: -10000px; top: 10px";target.focus();setTimeout(()=>{view.focus();target.remove();doPaste(view,target.value)},50)}}function doPaste(view,input){let {state:state$1}=view,changes,i=1,text=state$1.toText(input),byLine=text.lines==state$1.selection.ranges.length;if(null!=lastLinewiseCopy&&state$1.selection.ranges.every(r=>r.empty)&&
lastLinewiseCopy==text.toString()){let lastLine=-1;changes=state$1.changeByRange(range=>{let line=state$1.doc.lineAt(range.from);if(line.from==lastLine)return{range};lastLine=line.from;let insert=state$1.toText((byLine?text.line(i++).text:input)+state$1.lineBreak);return{changes:{from:line.from,insert},range:state$jscomp$0.EditorSelection.cursor(range.from+insert.length)}})}else changes=byLine?state$1.changeByRange(range=>{let line=text.line(i++);return{changes:{from:range.from,to:range.to,insert:line.text},
range:state$jscomp$0.EditorSelection.cursor(range.from+line.length)}}):state$1.replaceSelection(text);view.dispatch(changes,{userEvent:"input.paste",scrollIntoView:!0})}function rangeForClick(view,pos,bias,type){if(1==type)return state$jscomp$0.EditorSelection.cursor(pos,bias);if(2==type)return groupAt(view.state,pos,bias);bias=LineView.find(view.docView,pos);pos=view.state.doc.lineAt(bias?bias.posAtEnd:pos);type=bias?bias.posAtStart:pos.from;bias=bias?bias.posAtEnd:pos.to;bias<view.state.doc.length&&
bias==pos.to&&bias++;return state$jscomp$0.EditorSelection.range(type,bias)}function queryPos(view,event){let pos=view.posAtCoords({x:event.clientX,y:event.clientY},!1);{var JSCompiler_inline_result=event.clientX;event=event.clientY;let line=LineView.find(view.docView,pos);if(line){var off=pos-line.posAtStart;if(0==off)JSCompiler_inline_result=1;else if(off==line.length)JSCompiler_inline_result=-1;else{view=line.coordsAt(off,-1);var JSCompiler_temp;if(JSCompiler_temp=view)JSCompiler_temp=event>=view.top&&
event<=view.bottom&&JSCompiler_inline_result>=view.left&&JSCompiler_inline_result<=view.right;if(JSCompiler_temp)JSCompiler_inline_result=-1;else{if(JSCompiler_temp=off=line.coordsAt(off,1))JSCompiler_temp=event>=off.top&&event<=off.bottom&&JSCompiler_inline_result>=off.left&&JSCompiler_inline_result<=off.right;JSCompiler_inline_result=JSCompiler_temp?1:view&&event>=view.top&&event<=view.bottom?-1:1}}}else JSCompiler_inline_result=1}return{pos,bias:JSCompiler_inline_result}}function getClickType(event){if(!BadMouseDetail)return event.detail;
let last=lastMouseDown,lastTime=lastMouseDownTime;lastMouseDown=event;lastMouseDownTime=Date.now();return lastMouseDownCount=!last||lastTime>Date.now()-400&&2>Math.abs(last.clientX-event.clientX)&&2>Math.abs(last.clientY-event.clientY)?(lastMouseDownCount+1)%3:1}function basicMouseSelection(view,event$jscomp$0){let start=queryPos(view,event$jscomp$0),type=getClickType(event$jscomp$0),startSel=view.state.selection,last=start,lastEvent=event$jscomp$0;return{update(update){update.docChanged&&(start&&
(start.pos=update.changes.mapPos(start.pos)),startSel=startSel.map(update.changes),lastEvent=null)},get(event,extend,multiple){if(lastEvent&&event.clientX==lastEvent.clientX&&event.clientY==lastEvent.clientY)var cur=last;else cur=last=queryPos(view,event),lastEvent=event;if(!cur||!start)return startSel;event=rangeForClick(view,cur.pos,cur.bias,type);if(start.pos!=cur.pos&&!extend){var startRange=rangeForClick(view,start.pos,start.bias,type);cur=Math.min(startRange.from,event.from);startRange=Math.max(startRange.to,
event.to);event=cur<event.from?state$jscomp$0.EditorSelection.range(cur,startRange):state$jscomp$0.EditorSelection.range(startRange,cur)}return extend?startSel.replaceRange(startSel.main.extend(event.from,event.to)):multiple?startSel.addRange(event):state$jscomp$0.EditorSelection.create([event])}}}function dropText(view,event,text,direct){if(text){var dropPos=view.posAtCoords({x:event.clientX,y:event.clientY},!1);event.preventDefault();({mouseSelection:event}=view.inputState);direct=direct&&event&&
event.dragging&&event.dragMove?{from:event.dragging.from,to:event.dragging.to}:null;text={from:dropPos,insert:text};text=view.state.changes(direct?[direct,text]:text);view.focus();view.dispatch({changes:text,selection:{anchor:text.mapPos(dropPos,-1),head:text.mapPos(dropPos,1)},userEvent:direct?"move.drop":"input.drop"})}}function captureCopy(view,text){let parent=view.dom.parentNode;if(parent){var target=parent.appendChild(document.createElement("textarea"));target.style.cssText="position: fixed; left: -10000px; top: 10px";
target.value=text;target.focus();target.selectionEnd=text.length;target.selectionStart=0;setTimeout(()=>{target.remove();view.focus()},50)}}function updateForFocusChange(view){setTimeout(()=>{view.hasFocus!=view.inputState.notifiedFocused&&view.update([])},10)}function forceClearComposition(view,rapid){if(view.docView.compositionDeco.size){view.inputState.rapidCompositionStart=rapid;try{view.update([])}finally{view.inputState.rapidCompositionStart=!1}}}function mergeGaps(nodes,around){let before,
after;null==nodes[around]&&(before=nodes[around-1])instanceof HeightMapGap&&(after=nodes[around+1])instanceof HeightMapGap&&nodes.splice(around-1,3,new HeightMapGap(before.length+1+after.length))}function heightRelevantDecoChanges(a,b,diff){let comp=new DecorationComparator;state$jscomp$0.RangeSet.compare(a,b,diff,comp,0);return comp.changes}function visiblePixelRange(dom,paddingTop){let rect=dom.getBoundingClientRect(),left=Math.max(0,rect.left),right=Math.min(innerWidth,rect.right),top=Math.max(0,
rect.top),bottom=Math.min(innerHeight,rect.bottom),body=dom.ownerDocument.body;for(dom=dom.parentNode;dom&&dom!=body;)if(1==dom.nodeType){let style=window.getComputedStyle(dom);if((dom.scrollHeight>dom.clientHeight||dom.scrollWidth>dom.clientWidth)&&"visible"!=style.overflow){let parentRect=dom.getBoundingClientRect();left=Math.max(left,parentRect.left);right=Math.min(right,parentRect.right);top=Math.max(top,parentRect.top);bottom=Math.min(bottom,parentRect.bottom)}dom="absolute"==style.position||
"fixed"==style.position?dom.offsetParent:dom.parentNode}else if(11==dom.nodeType)dom=dom.host;else break;return{left:left-rect.left,right:Math.max(left,right)-rect.left,top:top-(rect.top+paddingTop),bottom:Math.max(top,bottom)-(rect.top+paddingTop)}}function fullPixelRange(dom,paddingTop){dom=dom.getBoundingClientRect();return{left:0,right:dom.right-dom.left,top:paddingTop,bottom:dom.bottom-(dom.top+paddingTop)}}function lineStructure(from$jscomp$0,to$jscomp$0,stateDeco){let ranges=[],pos=from$jscomp$0,
total=0;state$jscomp$0.RangeSet.spans(stateDeco,from$jscomp$0,to$jscomp$0,{span(){},point(from,to){from>pos&&(ranges.push({from:pos,to:from}),total+=from-pos);pos=to}},20);pos<to$jscomp$0&&(ranges.push({from:pos,to:to$jscomp$0}),total+=to$jscomp$0-pos);return{total,ranges}}function findPosition({total,ranges},ratio){if(0>=ratio)return ranges[0].from;if(1<=ratio)return ranges[ranges.length-1].to;total=Math.floor(total*ratio);for(ratio=0;;ratio++){let {from,to}=ranges[ratio],size=to-from;if(total<=
size)return from+total;total-=size}}function findFraction(structure,pos){let counted=0;for(let {from,to}of structure.ranges){if(pos<=to){counted+=pos-from;break}counted+=to-from}return counted/structure.total}function cutRange(ranges,from,to){for(let i=0;i<ranges.length;i++){let r=ranges[i];if(r.from<to&&r.to>from){let pieces=[];r.from<from&&pieces.push({from:r.from,to:from});r.to>to&&pieces.push({from:to,to:r.to});ranges.splice(i,1,...pieces);i+=pieces.length-1}}}function find(array,f){for(let val of array)if(f(val))return val}
function scaleBlock(block,scaler){if(1==scaler.scale)return block;let bTop=scaler.toDOM(block.top),bBottom=scaler.toDOM(block.bottom);return new BlockInfo(block.from,block.length,bTop,bBottom-bTop,Array.isArray(block.type)?block.type.map(b=>scaleBlock(b,scaler)):block.type)}function buildTheme(main,spec,scopes){return new styleMod.StyleModule(spec,{finish(sel){return/&/.test(sel)?sel.replace(/&\w*/,m=>{if("\x26"==m)return main;if(!scopes||!scopes[m])throw new RangeError(`Unsupported selector: ${m}`);
...
start,end,typeOver){let change;let sel=view.state.selection.main;if(-1<start){end=view.docView.domBoundsAround(start,end,0);if(!end||view.state.readOnly)return!1;let {from,to}=end;var newSel=view.docView.impreciseHead||view.docView.impreciseAnchor?[]:selectionPoints(view);start=new DOMReader(newSel,view.state);start.readRange(end.startDOM,end.endDOM);end=sel.from;let preferredSide=null;if(8===view.inputState.lastKeyCode&&view.inputState.lastKeyTime>Date.now()-100||browser.android&&start.text.length<
to-from)end=sel.to,preferredSide="end";if(end=findDiff(view.state.doc.sliceString(from,to,"￿"),start.text,end-from,preferredSide))browser.chrome&&13==view.inputState.lastKeyCode&&end.toB==end.from+2&&"￿￿"==start.text.slice(end.from,end.toB)&&end.toB--,change={from:from+end.from,to:from+end.toA,insert:state$jscomp$0.Text.of(start.text.slice(end.from,end.toB).split("￿"))};newSel=selectionFromPoints(newSel,from)}else if(view.hasFocus||!view.state.facet(editable)){end=view.observer.selectionRange;let {impreciseHead:iHead,
impreciseAnchor:iAnchor}=view.docView;start=iHead&&iHead.node==end.focusNode&&iHead.offset==end.focusOffset||!contains(view.contentDOM,end.focusNode)?view.state.selection.main.head:view.docView.posFromDOM(end.focusNode,end.focusOffset);end=iAnchor&&iAnchor.node==end.anchorNode&&iAnchor.offset==end.anchorOffset||!contains(view.contentDOM,end.anchorNode)?view.state.selection.main.anchor:view.docView.posFromDOM(end.anchorNode,end.anchorOffset);if(start!=sel.head||end!=sel.anchor)newSel=state$jscomp$0.EditorSelection.single(end,
...
if(isChar&&(event.shiftKey||event.altKey||event.metaKey||127<charCode)&&(baseName=w3cKeyname.base[event.keyCode])&&baseName!=name){if(runFor(map[prefix+modifiers(baseName,event,!0)])||event.shiftKey&&w3cKeyname.shift[event.keyCode]!=baseName&&runFor(map[prefix+modifiers(w3cKeyname.shift[event.keyCode],event,!1)]))return!0}else if(isChar&&event.shiftKey&&runFor(map[prefix+modifiers(name,event,!0)]))return!0}return fallthrough}function getBase(view){let rect=view.scrollDOM.getBoundingClientRect();return{left:(view.textDirection==
exports.Direction.LTR?rect.left:rect.right-view.scrollDOM.clientWidth)-view.scrollDOM.scrollLeft,top:rect.top-view.scrollDOM.scrollTop}}function wrappedLine(view,pos,inside){pos=state$jscomp$0.EditorSelection.cursor(pos);return{from:Math.max(inside.from,view.moveToLineBoundary(pos,!1,!0).from),to:Math.min(inside.to,view.moveToLineBoundary(pos,!0,!0).from),type:exports.BlockType.Text}}function blockAt(view,pos){view=view.lineBlockAt(pos);if(Array.isArray(view.type))for(let l of view.type)if(l.to>pos||
l.to==pos&&(l.to==view.to||l.type==exports.BlockType.Text))return l;return view}function measureRange(view,range){function piece(left,top,right,bottom){return new Piece(left-base.left,top-base.top-.01,right-left,bottom-top+.01,"cm-selectionBackground")}function pieces$jscomp$0({top,bottom,horizontal}){let pieces=[];for(let i=0;i<horizontal.length;i+=2)pieces.push(piece(horizontal[i],top,horizontal[i+1],bottom));return pieces}function drawForLine(from$jscomp$0,to$jscomp$0,line){function addSpan(from,
...
getBase(view);return new Piece(cursor.left-view.left,cursor.top-view.top,-1,cursor.bottom-cursor.top,primary?"cm-cursor cm-cursor-primary":"cm-cursor cm-cursor-secondary")}function iterMatches(doc,re,from,to,f){re.lastIndex=0;for(let cursor=doc.iterRange(from,to),pos=from,m;!cursor.next().done;pos+=cursor.value.length)if(!cursor.lineBreak)for(;m=re.exec(cursor.value);)f(pos+m.index,pos+m.index+m[0].length,m)}function matchRanges(view,maxLength){let visible=view.visibleRanges;if(1==visible.length&&
...
(v,p)=>v.domAtPos(p),p=>new DOMPos(text,Math.min(p,text.nodeValue.length))):new DOMPos(text,Math.min(pos,text.nodeValue.length))}sync(){this.setDOM(this.widget.toDOM())}localPosFromDOM(node,offset){let {topView,text}=this.widget;return topView?posFromDOMInCompositionTree(node,offset,topView,text):Math.min(offset,this.length)}ignoreMutation(){return!1}get overrideDOMText(){return null}coordsAt(pos$jscomp$0,side$jscomp$0){let {topView,text}=this.widget;return topView?scanCompositionTree(pos$jscomp$0,
side$jscomp$0,topView,text,(v,pos,side)=>v.coordsAt(pos,side),(pos,side)=>textCoords(text,pos,side)):textCoords(text,pos$jscomp$0,side$jscomp$0)}destroy(){var _a;super.destroy();null===(_a=this.widget.topView)||void 0===_a?void 0:_a.destroy()}get isEditable(){return!0}}class WidgetBufferView extends ContentView{constructor(side){super();this.side=side}get length(){return 0}merge(){return!1}become(other){return other instanceof WidgetBufferView&&other.side==this.side}split(){return new WidgetBufferView(this.side)}sync(){if(!this.dom){let dom=
...
[];this.dynamicDecorationMap=[];this.minWidthTo=this.minWidthFrom=this.minWidth=0;this.impreciseHead=this.impreciseAnchor=null;this.forceSelection=!1;this.lastUpdate=Date.now();this.setDOM(view.contentDOM);this.children=[new LineView];this.children[0].setParent(this);this.updateDeco();this.updateInner([new ChangedRange(0,0,0,view.state.doc.length)],0)}get root(){return this.view.root}get editorView(){return this.view}get length(){return this.view.state.doc.length}update(update){let changedRanges=
update.changedRanges;0<this.minWidth&&changedRanges.length&&(changedRanges.every(({fromA,toA})=>toA<this.minWidthFrom||fromA>this.minWidthTo)?(this.minWidthFrom=update.changes.mapPos(this.minWidthFrom,1),this.minWidthTo=update.changes.mapPos(this.minWidthTo,1)):this.minWidth=this.minWidthFrom=this.minWidthTo=0);if(0>this.view.inputState.composing)this.compositionDeco=Decoration.none;else if(update.transactions.length||this.dirty)this.compositionDeco=computeCompositionDeco(this.view,update.changes);
(browser.ie||browser.chrome)&&!this.compositionDeco.size&&update&&update.state.doc.lines!=update.startState.doc.lines&&(this.forceSelection=!0);var prevDeco=this.decorations;let deco=this.updateDeco();prevDeco=findChangedDeco(prevDeco,deco,update.changes);changedRanges=ChangedRange.extendWithRanges(changedRanges,prevDeco);if(0==this.dirty&&0==changedRanges.length)return!1;this.updateInner(changedRanges,update.startState.doc.length);update.transactions.length&&(this.lastUpdate=Date.now());return!0}updateInner(changes,
oldLength){this.view.viewState.mustMeasureContent=!0;this.updateChildren(changes,oldLength);let {observer}=this.view;observer.ignore(()=>{this.dom.style.height=this.view.viewState.contentHeight+"px";this.dom.style.flexBasis=this.minWidth?this.minWidth+"px":"";let track=browser.chrome||browser.ios?{node:observer.selectionRange.focusNode,written:!1}:void 0;this.sync(track);this.dirty=0;track&&(track.written||observer.selectionRange.focusNode!=track.node)&&(this.forceSelection=!0);this.dom.style.height=
""});changes=[];if(this.view.viewport.from||this.view.viewport.to<this.view.state.doc.length)for(let child of this.children)child instanceof BlockWidgetView&&child.widget instanceof BlockGapWidget&&changes.push(child.dom);observer.updateGaps(changes)}updateChildren(changes,oldLength){oldLength=this.childCursor(oldLength);for(let i=changes.length-1;;i--){let next=0<=i?changes[i]:null;if(!next)break;let {fromA,toA,fromB,toB}=next,{content,breakAtStart,openStart,openEnd}=ContentBuilder.build(this.view.state.doc,
fromB,toB,this.decorations,this.dynamicDecorationMap),{i:toI,off:toOff}=oldLength.findPos(toA,1),{i:fromI,off:fromOff}=oldLength.findPos(fromA,-1);replaceRange(this,fromI,fromOff,toI,toOff,content,breakAtStart,openStart,openEnd)}}updateSelection(mustRead=!1,fromPointer=!1){!mustRead&&this.view.observer.selectionRange.focusNode||this.view.observer.readSelectionRange();if(!(!fromPointer&&!this.mayControlSelection()||browser.ios&&this.view.inputState.rapidCompositionStart)){mustRead=this.forceSelection;
this.forceSelection=!1;var main=this.view.state.selection.main,anchor=this.domAtPos(main.anchor),head=main.empty?anchor:this.domAtPos(main.head);if(browser.gecko&&main.empty&&1==anchor.node.nodeType&&anchor.node.firstChild&&(0==anchor.offset||"false"==anchor.node.childNodes[anchor.offset-1].contentEditable)&&(anchor.offset==anchor.node.childNodes.length||"false"==anchor.node.childNodes[anchor.offset].contentEditable)){let dummy=document.createTextNode("");this.view.observer.ignore(()=>anchor.node.insertBefore(dummy,
anchor.node.childNodes[anchor.offset]||null));anchor=head=new DOMPos(dummy,0);mustRead=!0}var domSel=this.view.observer.selectionRange;!mustRead&&domSel.focusNode&&isEquivalentPosition(anchor.node,anchor.offset,domSel.anchorNode,domSel.anchorOffset)&&isEquivalentPosition(head.node,head.offset,domSel.focusNode,domSel.focusOffset)||(this.view.observer.ignore(()=>{var JSCompiler_temp;if(JSCompiler_temp=browser.android&&browser.chrome&&this.dom.contains(domSel.focusNode))a:{for(JSCompiler_temp=domSel.focusNode;JSCompiler_temp&&
JSCompiler_temp!=this.dom;JSCompiler_temp=JSCompiler_temp.assignedSlot||JSCompiler_temp.parentNode)if(1==JSCompiler_temp.nodeType&&"false"==JSCompiler_temp.contentEditable){JSCompiler_temp=!0;break a}JSCompiler_temp=!1}JSCompiler_temp&&(this.dom.blur(),this.dom.focus({preventScroll:!0}));if(JSCompiler_temp=getSelection(this.root))if(main.empty){if(browser.gecko){var JSCompiler_inline_result=anchor.node;var offset=anchor.offset;JSCompiler_inline_result=1!=JSCompiler_inline_result.nodeType?0:(offset&&
"false"==JSCompiler_inline_result.childNodes[offset-1].contentEditable?1:0)|(offset<JSCompiler_inline_result.childNodes.length&&"false"==JSCompiler_inline_result.childNodes[offset].contentEditable?2:0);JSCompiler_inline_result&&3!=JSCompiler_inline_result&&(offset=nearbyTextNode(anchor.node,anchor.offset,1==JSCompiler_inline_result?1:-1))&&(anchor=new DOMPos(offset,1==JSCompiler_inline_result?0:offset.nodeValue.length))}JSCompiler_temp.collapse(anchor.node,anchor.offset);null!=main.bidiLevel&&null!=
domSel.cursorBidiLevel&&(domSel.cursorBidiLevel=main.bidiLevel)}else JSCompiler_temp.extend?(JSCompiler_temp.collapse(anchor.node,anchor.offset),JSCompiler_temp.extend(head.node,head.offset)):(JSCompiler_inline_result=document.createRange(),main.anchor>main.head&&([anchor,head]=[head,anchor]),JSCompiler_inline_result.setEnd(head.node,head.offset),JSCompiler_inline_result.setStart(anchor.node,anchor.offset),JSCompiler_temp.removeAllRanges(),JSCompiler_temp.addRange(JSCompiler_inline_result))}),this.view.observer.setSelectionRange(anchor,
head));this.impreciseAnchor=anchor.precise?null:new DOMPos(domSel.anchorNode,domSel.anchorOffset);this.impreciseHead=head.precise?null:new DOMPos(domSel.focusNode,domSel.focusOffset)}}enforceCursorAssoc(){if(!this.compositionDeco.size){var cursor=this.view.state.selection.main,sel=getSelection(this.root);if(sel&&cursor.empty&&cursor.assoc&&sel.modify){var line=LineView.find(this,cursor.head);if(line){var lineStart=line.posAtStart;cursor.head!=lineStart&&cursor.head!=lineStart+line.length&&(line=this.coordsAt(cursor.head,
-1),lineStart=this.coordsAt(cursor.head,1),!line||!lineStart||line.bottom>lineStart.top||(line=this.domAtPos(cursor.head+cursor.assoc),sel.collapse(line.node,line.offset),sel.modify("move",0>cursor.assoc?"forward":"backward","lineboundary")))}}}}mayControlSelection(){let active=this.root.activeElement;return active==this.dom||hasSelection(this.dom,this.view.observer.selectionRange)&&!(active&&this.dom.contains(active))}nearest(dom){for(;dom;){let domView=ContentView.get(dom);if(domView&&domView.rootView==
...
this.length,i=this.children.length-1;;i--){let child=this.children[i],start=off-child.breakAfter-child.length;if(pos>start||pos==start&&child.type!=exports.BlockType.WidgetBefore&&child.type!=exports.BlockType.WidgetAfter&&(!i||2==side||this.children[i-1].breakAfter||this.children[i-1].type==exports.BlockType.WidgetBefore&&-2<side))return child.coordsAt(pos-start,side);off=start}}measureVisibleLineHeights(viewport){let result=[],{from,to}=viewport;viewport=this.view.contentDOM.clientWidth;let isWider=
viewport>Math.max(this.view.scrollDOM.clientWidth,this.minWidth)+1,widest=-1,ltr=this.view.textDirection==exports.Direction.LTR;for(let pos=0,i=0;i<this.children.length;i++){let child=this.children[i],end=pos+child.length;if(end>to)break;if(pos>=from){var childRect=child.dom.getBoundingClientRect();result.push(childRect.height);if(isWider){var last=child.dom.lastChild;last=last?clientRectsFor(last):[];last.length&&(last=last[last.length-1],childRect=ltr?last.right-childRect.left:childRect.right-last.left,
childRect>widest&&(widest=childRect,this.minWidth=viewport,this.minWidthFrom=pos,this.minWidthTo=end))}}pos=end+child.breakAfter}return result}textDirectionAt(pos){({i:pos}=this.childPos(pos,1));return"rtl"==getComputedStyle(this.children[pos].dom).direction?exports.Direction.RTL:exports.Direction.LTR}measureTextSize(){for(let child of this.children)if(child instanceof LineView){let measure=child.measureTextSize();if(measure)return measure}let dummy=document.createElement("div"),lineHeight,charWidth;
dummy.className="cm-line";dummy.style.width="99999px";dummy.textContent="abc def ghi jkl mno pqr stu";this.view.observer.ignore(()=>{this.dom.appendChild(dummy);let rect=clientRectsFor(dummy.firstChild)[0];lineHeight=dummy.getBoundingClientRect().height;charWidth=rect?rect.width/27:7;dummy.remove()});return{lineHeight,charWidth}}childCursor(pos=this.length){let i=this.children.length;i&&(pos-=this.children[--i].length);return new ChildCursor(this.children,pos,i)}computeBlockGapDeco(){let deco=[],
vs=this.view.viewState;for(let pos=0,i=0;;i++){let next=i==vs.viewports.length?null:vs.viewports[i],end=next?next.from-1:this.length;if(end>pos){let height=vs.lineBlockAt(end).bottom-vs.lineBlockAt(pos).top;deco.push(Decoration.replace({widget:new BlockGapWidget(height),block:!0,inclusive:!0,isBlockGap:!0}).range(pos,end))}if(!next)break;pos=next.to+1}return Decoration.set(deco)}updateDeco(){let allDeco=this.view.state.facet(decorations).map((d,i)=>(this.dynamicDecorationMap[i]="function"==typeof d)?
d(this.view):d);for(let i=allDeco.length;i<allDeco.length+3;i++)this.dynamicDecorationMap[i]=!1;return this.decorations=[...allDeco,this.compositionDeco,this.computeBlockGapDeco(),this.view.viewState.lineGapDeco]}scrollIntoView(target){let {range}=target,rect=this.coordsAt(range.head,range.empty?range.assoc:range.head>range.anchor?-1:1);var other;if(rect){!range.empty&&(other=this.coordsAt(range.anchor,range.anchor>range.head?-1:1))&&(rect={left:Math.min(rect.left,other.left),top:Math.min(rect.top,
other.top),right:Math.max(rect.right,other.right),bottom:Math.max(rect.bottom,other.bottom)});var mRight=other=0,mTop=0,mBottom=0;for(let margins of this.view.state.facet(scrollMargins).map(f=>f(this.view)))if(margins){let {left,right,top,bottom}=margins;null!=left&&(other=Math.max(other,left));null!=right&&(mRight=Math.max(mRight,right));null!=top&&(mTop=Math.max(mTop,top));null!=bottom&&(mBottom=Math.max(mBottom,bottom))}scrollRectIntoView(this.view.scrollDOM,{left:rect.left-other,top:rect.top-
mTop,right:rect.right+mRight,bottom:rect.bottom+mBottom},range.head<range.anchor?-1:1,target.x,target.y,target.xMargin,target.yMargin,this.view.textDirection==exports.Direction.LTR)}}}class BlockGapWidget extends WidgetType{constructor(height){super();this.height=height}toDOM(){let elt=document.createElement("div");this.updateDOM(elt);return elt}eq(other){return other.height==this.height}updateDOM(elt){elt.style.height=this.height+"px";return!0}get estimatedHeight(){return this.height}}class CompositionWidget extends WidgetType{constructor(top,
text,topView){super();this.top=top;this.text=text;this.topView=topView}eq(other){return this.top==other.top&&this.text==other.text}toDOM(){return this.top}ignoreEvent(){return!1}get customView(){return CompositionView}}class DecorationComparator$1{constructor(){this.changes=[]}compareRange(from,to){addRange(from,to,this.changes)}comparePoint(from,to){addRange(from,to,this.changes)}}class InputState{constructor(view){this.lastKeyTime=this.lastKeyCode=0;this.chromeScrollHack=-1;this.pendingIOSKey=void 0;
this.lastSelectionOrigin=null;this.lastContextMenu=this.lastEscPress=this.lastSelectionTime=0;this.scrollHandlers=[];this.registeredEvents=[];this.customHandlers=[];this.composing=-1;this.compositionFirstChange=null;this.compositionEndedAt=0;this.rapidCompositionStart=!1;this.mouseSelection=null;for(let type in handlers){let handler=handlers[type];view.contentDOM.addEventListener(type,event=>{!eventBelongsToEditor(view,event)||this.ignoreDuringComposition(event)||"keydown"==type&&this.keydown(view,
event)||(this.mustFlushObserver(event)&&view.observer.forceFlush(),this.runCustomHandlers(type,view,event)?event.preventDefault():handler(view,event))});this.registeredEvents.push(type)}browser.chrome&&102<=browser.chrome_version&&view.scrollDOM.addEventListener("wheel",()=>{0>this.chromeScrollHack?view.contentDOM.style.pointerEvents="none":window.clearTimeout(this.chromeScrollHack);this.chromeScrollHack=setTimeout(()=>{this.chromeScrollHack=-1;view.contentDOM.style.pointerEvents=""},100)},{passive:!0});
this.notifiedFocused=view.hasFocus;browser.safari&&view.contentDOM.addEventListener("input",()=>null)}setSelectionOrigin(origin){this.lastSelectionOrigin=origin;this.lastSelectionTime=Date.now()}ensureHandlers(view,plugins){var _a;this.customHandlers=[];for(let plugin of plugins)if(plugins=null===(_a=plugin.update(view).spec)||void 0===_a?void 0:_a.domEventHandlers){this.customHandlers.push({plugin:plugin.value,handlers:plugins});for(let type in plugins)0>this.registeredEvents.indexOf(type)&&"scroll"!=
type&&(this.registeredEvents.push(type),view.contentDOM.addEventListener(type,event=>{eventBelongsToEditor(view,event)&&this.runCustomHandlers(type,view,event)&&event.preventDefault()}))}}runCustomHandlers(type,view,event){for(let set of this.customHandlers){let handler=set.handlers[type];if(handler)try{if(handler.call(set.plugin,event,view)||event.defaultPrevented)return!0}catch(e){logException(view.state,e)}}return!1}runScrollHandlers(view,event){for(let set of this.customHandlers){let handler=
set.handlers.scroll;if(handler)try{handler.call(set.plugin,event,view)}catch(e){logException(view.state,e)}}}keydown(view,event){this.lastKeyCode=event.keyCode;this.lastKeyTime=Date.now();if(9==event.keyCode&&Date.now()<this.lastEscPress+2E3)return!0;if(browser.android&&browser.chrome&&!event.synthetic&&(13==event.keyCode||8==event.keyCode))return view.observer.delayAndroidKey(event.key,event.keyCode),!0;let pending;return!browser.ios||!(pending=PendingKeys.find(key=>key.keyCode==event.keyCode))||
event.ctrlKey||event.altKey||event.metaKey||event.synthetic?!1:(this.pendingIOSKey=pending,setTimeout(()=>this.flushIOSKey(view),250),!0)}flushIOSKey(view){let key=this.pendingIOSKey;if(!key)return!1;this.pendingIOSKey=void 0;return dispatchKey(view.contentDOM,key.key,key.keyCode)}ignoreDuringComposition(event){return/^key/.test(event.type)?0<this.composing?!0:browser.safari&&100>Date.now()-this.compositionEndedAt?(this.compositionEndedAt=0,!0):!1:!1}mustFlushObserver(event){return"keydown"==event.type&&
229!=event.keyCode||"compositionend"==event.type&&!browser.ios}startMouseSelection(mouseSelection){this.mouseSelection&&this.mouseSelection.destroy();this.mouseSelection=mouseSelection}update(update){this.mouseSelection&&this.mouseSelection.update(update);update.transactions.length&&(this.lastKeyCode=this.lastSelectionTime=0)}destroy(){this.mouseSelection&&this.mouseSelection.destroy()}}const PendingKeys=[{key:"Backspace",keyCode:8,inputType:"deleteContentBackward"},{key:"Enter",keyCode:13,inputType:"insertParagraph"},
{key:"Delete",keyCode:46,inputType:"deleteContentForward"}],modifierCodes=[16,17,18,20,91,92,224,225];class MouseSelection{constructor(view,startEvent,style,mustSelect){this.view=view;this.style=style;this.mustSelect=mustSelect;this.lastEvent=startEvent;style=view.contentDOM.ownerDocument;style.addEventListener("mousemove",this.move=this.move.bind(this));style.addEventListener("mouseup",this.up=this.up.bind(this));this.extend=startEvent.shiftKey;if(style=view.state.facet(state$jscomp$0.EditorState.allowMultipleSelections))style=
view.state.facet(clickAddsSelectionRange),style=style.length?style[0](startEvent):browser.mac?startEvent.metaKey:startEvent.ctrlKey;this.multiple=style;style=view.state.facet(dragMovesSelection$1);this.dragMove=style.length?style[0](startEvent):browser.mac?!startEvent.altKey:!startEvent.ctrlKey;this.dragging=isInPrimarySelection(view,startEvent)&&1==getClickType(startEvent)?null:!1;!1===this.dragging&&(startEvent.preventDefault(),this.select(startEvent))}move(event){if(0==event.buttons)return this.destroy();
!1===this.dragging&&this.select(this.lastEvent=event)}up(event){null==this.dragging&&this.select(this.lastEvent);this.dragging||event.preventDefault();this.destroy()}destroy(){let doc=this.view.contentDOM.ownerDocument;doc.removeEventListener("mousemove",this.move);doc.removeEventListener("mouseup",this.up);this.view.inputState.mouseSelection=null}select(event){event=this.style.get(event,this.extend,this.multiple);!this.mustSelect&&event.eq(this.view.state.selection)&&event.main.assoc==this.view.state.selection.main.assoc||
this.view.dispatch({selection:event,userEvent:"select.pointer",scrollIntoView:!0});this.mustSelect=!1}update(update){update.docChanged&&this.dragging&&(this.dragging=this.dragging.map(update.changes));this.style.update(update)&&setTimeout(()=>this.select(this.lastEvent),20)}}const handlers=Object.create(null),brokenClipboardAPI=browser.ie&&15>browser.ie_version||browser.ios&&604>browser.webkit_version;handlers.keydown=(view,event)=>{view.inputState.setSelectionOrigin("select");27==event.keyCode?view.inputState.lastEscPress=
Date.now():0>modifierCodes.indexOf(event.keyCode)&&(view.inputState.lastEscPress=0)};let lastTouch=0;handlers.touchstart=(view,e)=>{lastTouch=Date.now();view.inputState.setSelectionOrigin("select.pointer")};handlers.touchmove=view=>{view.inputState.setSelectionOrigin("select.pointer")};handlers.mousedown=(view,event)=>{view.observer.flush();if(!(lastTouch>Date.now()-2E3&&1==getClickType(event))){var style=null;for(var makeStyle of view.state.facet(mouseSelectionStyle))if(style=makeStyle(view,event))break;
style||0!=event.button||(style=basicMouseSelection(view,event));style&&((makeStyle=view.root.activeElement!=view.contentDOM)&&view.observer.ignore(()=>focusPreventScroll(view.contentDOM)),view.inputState.startMouseSelection(new MouseSelection(view,event,style,makeStyle)))}};const BadMouseDetail=browser.ie&&11>=browser.ie_version;let lastMouseDown=null,lastMouseDownCount=0,lastMouseDownTime=0;handlers.dragstart=(view,event)=>{let {selection:{main}}=view.state,{mouseSelection}=view.inputState;mouseSelection&&
(mouseSelection.dragging=main);event.dataTransfer&&(event.dataTransfer.setData("Text",view.state.sliceDoc(main.from,main.to)),event.dataTransfer.effectAllowed="copyMove")};handlers.drop=(view,event)=>{if(event.dataTransfer){if(view.state.readOnly)return event.preventDefault();var files=event.dataTransfer.files;if(files&&files.length){event.preventDefault();let text=Array(files.length),read=0,finishFile=()=>{++read==files.length&&dropText(view,event,text.filter(s=>null!=s).join(view.state.lineBreak),
!1)};for(let i=0;i<files.length;i++){let reader=new FileReader;reader.onerror=finishFile;reader.onload=()=>{/[\x00-\x08\x0e-\x1f]{2}/.test(reader.result)||(text[i]=reader.result);finishFile()};reader.readAsText(files[i])}}else dropText(view,event,event.dataTransfer.getData("Text"),!0)}};handlers.paste=(view,event)=>{if(view.state.readOnly)return event.preventDefault();view.observer.flush();let data=brokenClipboardAPI?null:event.clipboardData;data?(doPaste(view,data.getData("text/plain")),event.preventDefault()):
capturePaste(view)};let lastLinewiseCopy=null;handlers.copy=handlers.cut=(view,event)=>{var JSCompiler_inline_result=view.state;let content=[],ranges=[];var linewise=!1;for(var range of JSCompiler_inline_result.selection.ranges)range.empty||(content.push(JSCompiler_inline_result.sliceDoc(range.from,range.to)),ranges.push(range));if(!content.length){linewise=-1;for(let {from}of JSCompiler_inline_result.selection.ranges)range=JSCompiler_inline_result.doc.lineAt(from),range.number>linewise&&(content.push(range.text),
ranges.push({from:range.from,to:Math.min(JSCompiler_inline_result.doc.length,range.to+1)})),linewise=range.number;linewise=!0}JSCompiler_inline_result={text:content.join(JSCompiler_inline_result.lineBreak),ranges,linewise};let {text,ranges:ranges$jscomp$0,linewise:linewise$jscomp$0}=JSCompiler_inline_result;if(text||linewise$jscomp$0)lastLinewiseCopy=linewise$jscomp$0?text:null,(JSCompiler_inline_result=brokenClipboardAPI?null:event.clipboardData)?(event.preventDefault(),JSCompiler_inline_result.clearData(),
JSCompiler_inline_result.setData("text/plain",text)):captureCopy(view,text),"cut"!=event.type||view.state.readOnly||view.dispatch({changes:ranges$jscomp$0,scrollIntoView:!0,userEvent:"delete.cut"})};handlers.focus=updateForFocusChange;handlers.blur=view=>{view.observer.clearSelectionRange();updateForFocusChange(view)};handlers.compositionstart=handlers.compositionupdate=view=>{null==view.inputState.compositionFirstChange&&(view.inputState.compositionFirstChange=!0);0>view.inputState.composing&&(view.inputState.composing=
0,view.docView.compositionDeco.size&&(view.observer.flush(),forceClearComposition(view,!0)))};handlers.compositionend=view=>{view.inputState.composing=-1;view.inputState.compositionEndedAt=Date.now();view.inputState.compositionFirstChange=null;setTimeout(()=>{0>view.inputState.composing&&forceClearComposition(view,!1)},50)};handlers.contextmenu=view=>{view.inputState.lastContextMenu=Date.now()};handlers.beforeinput=(view,event)=>{var _a$jscomp$0;let pending;if(browser.chrome&&browser.android&&(pending=
PendingKeys.find(key=>key.inputType==event.inputType))&&(view.observer.delayAndroidKey(pending.key,pending.keyCode),"Backspace"==pending.key||"Delete"==pending.key)){let startViewHeight=(null===(_a$jscomp$0=window.visualViewport)||void 0===_a$jscomp$0?void 0:_a$jscomp$0.height)||0;setTimeout(()=>{var _a;((null===(_a=window.visualViewport)||void 0===_a?void 0:_a.height)||0)>startViewHeight+10&&view.hasFocus&&(view.contentDOM.blur(),view.focus())},100)}};const wrappingWhiteSpace=["pre-wrap","normal",
"pre-line","break-spaces"];class HeightOracle{constructor(){this.doc=state$jscomp$0.Text.empty;this.lineWrapping=!1;this.heightSamples={};this.lineHeight=14;this.charWidth=7;this.lineLength=30;this.heightChanged=!1}heightForGap(from,to){let lines=this.doc.lineAt(to).number-this.doc.lineAt(from).number+1;this.lineWrapping&&(lines+=Math.ceil((to-from-lines*this.lineLength*.5)/this.lineLength));return this.lineHeight*lines}heightForLine(length){return this.lineWrapping?(1+Math.max(0,Math.ceil((length-
this.lineLength)/(this.lineLength-5))))*this.lineHeight:this.lineHeight}setDoc(doc){this.doc=doc;return this}mustRefreshForWrapping(whiteSpace){return-1<wrappingWhiteSpace.indexOf(whiteSpace)!=this.lineWrapping}mustRefreshForHeights(lineHeights){let newHeight=!1;for(let i=0;i<lineHeights.length;i++){let h=lineHeights[i];0>h?i++:this.heightSamples[Math.floor(10*h)]||(newHeight=!0,this.heightSamples[Math.floor(10*h)]=!0)}return newHeight}refresh(whiteSpace,lineHeight,charWidth,lineLength,knownHeights){let lineWrapping=
-1<wrappingWhiteSpace.indexOf(whiteSpace);whiteSpace=Math.round(lineHeight)!=Math.round(this.lineHeight)||this.lineWrapping!=lineWrapping;this.lineWrapping=lineWrapping;this.lineHeight=lineHeight;this.charWidth=charWidth;this.lineLength=lineLength;if(whiteSpace)for(this.heightSamples={},lineHeight=0;lineHeight<knownHeights.length;lineHeight++)charWidth=knownHeights[lineHeight],0>charWidth?lineHeight++:this.heightSamples[Math.floor(10*charWidth)]=!0;return whiteSpace}}class MeasuredHeights{constructor(from,
...
return new HeightMapBranch(HeightMap.of(nodes.slice(0,i)),before,HeightMap.of(nodes.slice(j)))}}HeightMap.prototype.size=1;class HeightMapBlock extends HeightMap{constructor(length,height,type){super(length,height);this.type=type}blockAt(_height,_doc,top,offset){return new BlockInfo(offset,this.length,top,this.height,this.type)}lineAt(_value,_type,doc,top,offset){return this.blockAt(0,doc,top,offset)}forEachLine(from,to,doc,top,offset,f){from<=offset+this.length&&to>=offset&&f(this.blockAt(0,doc,
top,offset))}updateHeight(oracle,offset=0,_force,measured){measured&&measured.from<=offset&&measured.more&&this.setHeight(oracle,measured.heights[measured.index++]);this.outdated=!1;return this}toString(){return`block(${this.length})`}}class HeightMapText extends HeightMapBlock{constructor(length,height){super(length,height,exports.BlockType.Text);this.widgetHeight=this.collapsed=0}replace(_from,_to,nodes){_from=nodes[0];return 1==nodes.length&&(_from instanceof HeightMapText||_from instanceof HeightMapGap&&
_from.flags&4)&&10>Math.abs(this.length-_from.length)?(_from instanceof HeightMapGap?_from=new HeightMapText(_from.length,this.height):_from.height=this.height,this.outdated||(_from.outdated=!1),_from):HeightMap.of(nodes)}updateHeight(oracle,offset=0,force=!1,measured){measured&&measured.from<=offset&&measured.more?this.setHeight(oracle,measured.heights[measured.index++]):(force||this.outdated)&&this.setHeight(oracle,Math.max(this.widgetHeight,oracle.heightForLine(this.length-this.collapsed)));this.outdated=
!1;return this}toString(){return`line(${this.length}${this.collapsed?-this.collapsed:""}${this.widgetHeight?":"+this.widgetHeight:""})`}}class HeightMapGap extends HeightMap{constructor(length){super(length,0)}lines(doc,offset){let firstLine=doc.lineAt(offset).number;doc=doc.lineAt(offset+this.length).number;return{firstLine,lastLine:doc,lineHeight:this.height/(doc-firstLine+1)}}blockAt(height,doc,top,offset){let {firstLine,lastLine,lineHeight}=this.lines(doc,offset);height=Math.max(0,Math.min(lastLine-
firstLine,Math.floor((height-top)/lineHeight)));let {from,length}=doc.line(firstLine+height);return new BlockInfo(from,length,top+lineHeight*height,lineHeight,exports.BlockType.Text)}lineAt(value,type,doc,top,offset){if(type==QueryType.ByHeight)return this.blockAt(value,doc,top,offset);if(type==QueryType.ByPosNoHeight){let {from,to}=doc.lineAt(value);return new BlockInfo(from,to-from,0,0,exports.BlockType.Text)}let {firstLine,lineHeight}=this.lines(doc,offset),{from:from$jscomp$0,length,number}=doc.lineAt(value);
return new BlockInfo(from$jscomp$0,length,top+lineHeight*(number-firstLine),lineHeight,exports.BlockType.Text)}forEachLine(from,to,doc,top,offset,f){let {firstLine,lineHeight}=this.lines(doc,offset);for(let pos=Math.max(from,offset),end=Math.min(offset+this.length,to);pos<=end;)to=doc.lineAt(pos),pos==from&&(top+=lineHeight*(to.number-firstLine)),f(new BlockInfo(to.from,to.length,top,lineHeight,exports.BlockType.Text)),top+=lineHeight,pos=to.to+1}replace(from,to,nodes){to=this.length-to;if(0<to){let last=
nodes[nodes.length-1];last instanceof HeightMapGap?nodes[nodes.length-1]=new HeightMapGap(last.length+to):nodes.push(null,new HeightMapGap(to-1))}0<from&&(to=nodes[0],to instanceof HeightMapGap?nodes[0]=new HeightMapGap(from+to.length):nodes.unshift(new HeightMapGap(from-1),null));return HeightMap.of(nodes)}decomposeLeft(to,result){result.push(new HeightMapGap(to-1),null)}decomposeRight(from,result){result.push(null,new HeightMapGap(this.length-from-1))}updateHeight(oracle,offset=0,force=!1,measured){let end=
offset+this.length;if(measured&&measured.from<=offset+this.length&&measured.more){let nodes=[],pos=Math.max(offset,measured.from);force=-1;let wasChanged=oracle.heightChanged;for(measured.from>offset&&nodes.push((new HeightMapGap(measured.from-offset-1)).updateHeight(oracle,offset));pos<=end&&measured.more;){let len=oracle.doc.lineAt(pos).length;nodes.length&&nodes.push(null);var height=measured.heights[measured.index++];-1==force?force=height:.001<=Math.abs(height-force)&&(force=-2);height=new HeightMapText(len,
height);height.outdated=!1;nodes.push(height);pos+=len+1}pos<=end&&nodes.push(null,(new HeightMapGap(end-pos)).updateHeight(oracle,pos));measured=HeightMap.of(nodes);oracle.heightChanged=wasChanged||0>force||.001<=Math.abs(measured.height-this.height)||.001<=Math.abs(force-this.lines(oracle.doc,offset).lineHeight);return measured}if(force||this.outdated)this.setHeight(oracle,oracle.heightForGap(offset,offset+this.length)),this.outdated=!1;return this}toString(){return`gap(${this.length})`}}class HeightMapBranch extends HeightMap{constructor(left,
...
to){oracle=new NodeBuilder(from,oracle);state$jscomp$0.RangeSet.spans(decorations,from,to,oracle,0);return oracle.finish(from)}}class DecorationComparator{constructor(){this.changes=[]}compareRange(){}comparePoint(from,to,a,b){(from<to||a&&a.heightRelevant||b&&b.heightRelevant)&&addRange(from,to,this.changes,5)}}class LineGap{constructor(from,to,size){this.from=from;this.to=to;this.size=size}static same(a,b){if(a.length!=b.length)return!1;for(let i=0;i<a.length;i++){let gA=a[i],gB=b[i];if(gA.from!=
gB.from||gA.to!=gB.to||gA.size!=gB.size)return!1}return!0}draw(wrapping){return Decoration.replace({widget:new LineGapWidget(this.size,wrapping)}).range(this.from,this.to)}}class LineGapWidget extends WidgetType{constructor(size,vertical){super();this.size=size;this.vertical=vertical}eq(other){return other.size==this.size&&other.vertical==this.vertical}toDOM(){let elt=document.createElement("div");this.vertical?elt.style.height=this.size+"px":(elt.style.width=this.size+"px",elt.style.height="2px",
elt.style.display="inline-block");return elt}get estimatedHeight(){return this.vertical?this.size:-1}}class ViewState{constructor(state$1){this.state=state$1;this.pixelViewport={left:0,right:window.innerWidth,top:0,bottom:0};this.inView=!0;this.editorWidth=this.editorHeight=this.contentDOMHeight=this.contentDOMWidth=this.paddingBottom=this.paddingTop=0;this.heightOracle=new HeightOracle;this.scaler=IdScaler;this.scrollTarget=null;this.printing=!1;this.mustMeasureContent=!0;this.defaultTextDirection=
exports.Direction.RTL;this.visibleRanges=[];this.mustEnforceCursorAssoc=!1;this.stateDeco=state$1.facet(decorations).filter(d=>"function"!=typeof d);this.heightMap=HeightMap.empty().applyChanges(this.stateDeco,state$jscomp$0.Text.empty,this.heightOracle.setDoc(state$1.doc),[new ChangedRange(0,0,0,state$1.doc.length)]);this.viewport=this.getViewport(0,null);this.updateViewportLines();this.updateForViewport();this.lineGaps=this.ensureLineGaps([]);this.lineGapDeco=Decoration.set(this.lineGaps.map(gap=>
gap.draw(!1)));this.computeVisibleRanges()}updateForViewport(){let viewports=[this.viewport],{main}=this.state.selection;for(let i=0;1>=i;i++){let pos=i?main.head:main.anchor;if(!viewports.some(({from,to})=>pos>=from&&pos<=to)){let {from,to}=this.lineBlockAt(pos);viewports.push(new Viewport(from,to))}}this.viewports=viewports.sort((a,b)=>a.from-b.from);this.scaler=7E6>=this.heightMap.height?IdScaler:new BigScaler(this.heightOracle.doc,this.heightMap,this.viewports)}updateViewportLines(){this.viewportLines=
[];this.heightMap.forEachLine(this.viewport.from,this.viewport.to,this.state.doc,0,0,block=>{this.viewportLines.push(1==this.scaler.scale?block:scaleBlock(block,this.scaler))})}update(update,scrollTarget=null){this.state=update.state;var prevDeco=this.stateDeco;this.stateDeco=this.state.facet(decorations).filter(d=>"function"!=typeof d);prevDeco=ChangedRange.extendWithRanges(update.changedRanges,heightRelevantDecoChanges(prevDeco,this.stateDeco,update?update.changes:state$jscomp$0.ChangeSet.empty(this.state.doc.length)));
var prevHeight=this.heightMap.height;this.heightMap=this.heightMap.applyChanges(this.stateDeco,update.startState.doc,this.heightOracle.setDoc(this.state.doc),prevDeco);this.heightMap.height!=prevHeight&&(update.flags|=2);prevDeco=prevDeco.length?this.mapViewport(this.viewport,update.changes):this.viewport;if(scrollTarget&&(scrollTarget.range.head<prevDeco.from||scrollTarget.range.head>prevDeco.to)||!this.viewportIsAppropriate(prevDeco))prevDeco=this.getViewport(0,scrollTarget);prevHeight=!update.changes.empty||
update.flags&2||prevDeco.from!=this.viewport.from||prevDeco.to!=this.viewport.to;this.viewport=prevDeco;this.updateForViewport();prevHeight&&this.updateViewportLines();(this.lineGaps.length||4E3<this.viewport.to-this.viewport.from)&&this.updateLineGaps(this.ensureLineGaps(this.mapLineGaps(this.lineGaps,update.changes)));update.flags|=this.computeVisibleRanges();scrollTarget&&(this.scrollTarget=scrollTarget);!this.mustEnforceCursorAssoc&&update.selectionSet&&update.view.lineWrapping&&update.state.selection.main.empty&&
update.state.selection.main.assoc&&(this.mustEnforceCursorAssoc=!0)}measure(view){var dom=view.contentDOM,style=window.getComputedStyle(dom),oracle=this.heightOracle,whiteSpace=style.whiteSpace;this.defaultTextDirection="rtl"==style.direction?exports.Direction.RTL:exports.Direction.LTR;let refresh=this.heightOracle.mustRefreshForWrapping(whiteSpace);var measureContent=refresh||this.mustMeasureContent||this.contentDOMHeight!=dom.clientHeight;this.contentDOMHeight=dom.clientHeight;this.mustMeasureContent=
!1;let result=0,bias=0;var paddingTop=parseInt(style.paddingTop)||0;style=parseInt(style.paddingBottom)||0;if(this.paddingTop!=paddingTop||this.paddingBottom!=style)this.paddingTop=paddingTop,this.paddingBottom=style,result|=10;this.editorWidth!=view.scrollDOM.clientWidth&&(oracle.lineWrapping&&(measureContent=!0),this.editorWidth=view.scrollDOM.clientWidth,result|=8);var pixelViewport=(this.printing?fullPixelRange:visiblePixelRange)(dom,this.paddingTop);paddingTop=pixelViewport.top-this.pixelViewport.top;
style=pixelViewport.bottom-this.pixelViewport.bottom;this.pixelViewport=pixelViewport;pixelViewport=this.pixelViewport.bottom>this.pixelViewport.top&&this.pixelViewport.right>this.pixelViewport.left;pixelViewport!=this.inView&&(this.inView=pixelViewport)&&(measureContent=!0);if(!this.inView)return 0;dom=dom.clientWidth;if(this.contentDOMWidth!=dom||this.editorHeight!=view.scrollDOM.clientHeight)this.contentDOMWidth=dom,this.editorHeight=view.scrollDOM.clientHeight,result|=8;if(measureContent){measureContent=
view.docView.measureVisibleLineHeights(this.viewport);oracle.mustRefreshForHeights(measureContent)&&(refresh=!0);if(refresh||oracle.lineWrapping&&Math.abs(dom-this.contentDOMWidth)>oracle.charWidth){let {lineHeight,charWidth}=view.docView.measureTextSize();if(refresh=oracle.refresh(whiteSpace,lineHeight,charWidth,dom/charWidth,measureContent))view.docView.minWidth=0,result|=8}0<paddingTop&&0<style?bias=Math.max(paddingTop,style):0>paddingTop&&0>style&&(bias=Math.min(paddingTop,style));oracle.heightChanged=
!1;for(let vp of this.viewports)whiteSpace=vp.from==this.viewport.from?measureContent:view.docView.measureVisibleLineHeights(vp),this.heightMap=this.heightMap.updateHeight(oracle,0,refresh,new MeasuredHeights(vp.from,whiteSpace));oracle.heightChanged&&(result|=2)}if(oracle=!this.viewportIsAppropriate(this.viewport,bias)||this.scrollTarget&&(this.scrollTarget.range.head<this.viewport.from||this.scrollTarget.range.head>this.viewport.to))this.viewport=this.getViewport(bias,this.scrollTarget);this.updateForViewport();
(result&2||oracle)&&this.updateViewportLines();(this.lineGaps.length||4E3<this.viewport.to-this.viewport.from)&&this.updateLineGaps(this.ensureLineGaps(refresh?[]:this.lineGaps));result|=this.computeVisibleRanges();this.mustEnforceCursorAssoc&&(this.mustEnforceCursorAssoc=!1,view.docView.enforceCursorAssoc());return result}get visibleTop(){return this.scaler.fromDOM(this.pixelViewport.top)}get visibleBottom(){return this.scaler.fromDOM(this.pixelViewport.bottom)}getViewport(bias,scrollTarget){var marginTop=
.5-Math.max(-.5,Math.min(.5,bias/1E3/2));bias=this.heightMap;let doc=this.state.doc,{visibleTop,visibleBottom}=this,viewport=new Viewport(bias.lineAt(visibleTop-1E3*marginTop,QueryType.ByHeight,doc,0,0).from,bias.lineAt(visibleBottom+1E3*(1-marginTop),QueryType.ByHeight,doc,0,0).to);if(scrollTarget){let {head}=scrollTarget.range;if(head<viewport.from||head>viewport.to){marginTop=Math.min(this.editorHeight,this.pixelViewport.bottom-this.pixelViewport.top);let block=bias.lineAt(head,QueryType.ByPos,
doc,0,0);scrollTarget="center"==scrollTarget.y?(block.top+block.bottom)/2-marginTop/2:"start"==scrollTarget.y||"nearest"==scrollTarget.y&&head<viewport.from?block.top:block.bottom-marginTop;viewport=new Viewport(bias.lineAt(scrollTarget-500,QueryType.ByHeight,doc,0,0).from,bias.lineAt(scrollTarget+marginTop+500,QueryType.ByHeight,doc,0,0).to)}}return viewport}mapViewport(viewport,changes){let from=changes.mapPos(viewport.from,-1);viewport=changes.mapPos(viewport.to,1);return new Viewport(this.heightMap.lineAt(from,
...
top>visibleTop-2E3&&bottom<visibleBottom+2E3}mapLineGaps(gaps,changes){if(!gaps.length||changes.empty)return gaps;let mapped=[];for(let gap of gaps)changes.touchesRange(gap.from,gap.to)||mapped.push(new LineGap(changes.mapPos(gap.from),changes.mapPos(gap.to),gap.size));return mapped}ensureLineGaps(current){let gaps=[];if(this.defaultTextDirection!=exports.Direction.LTR)return gaps;for(let line of this.viewportLines){if(4E3>line.length)continue;let structure=lineStructure(line.from,line.to,this.stateDeco);
...
borderLeft:"1.2px solid black",marginLeft:"-0.6px",pointerEvents:"none"},".cm-cursor":{display:"none"},"\x26dark .cm-cursor":{borderLeftColor:"#444"},"\x26.cm-focused .cm-cursor":{display:"block"},"\x26light .cm-activeLine":{backgroundColor:"#f3f9ff"},"\x26dark .cm-activeLine":{backgroundColor:"#223039"},"\x26light .cm-specialChar":{color:"red"},"\x26dark .cm-specialChar":{color:"#f78"},".cm-gutters":{display:"flex",height:"100%",boxSizing:"border-box",left:0,zIndex:200},"\x26light .cm-gutters":{backgroundColor:"#f5f5f5",
...
color:"inherit",fontSize:"70%",border:"1px solid silver",padding:".2em .5em"},"\x26light .cm-textfield":{backgroundColor:"white"},"\x26dark .cm-textfield":{border:"1px solid #555",backgroundColor:"inherit"}},lightDarkIDs),observeOptions={childList:!0,characterData:!0,subtree:!0,attributes:!0,characterDataOldValue:!0},useCharData=browser.ie&&11>=browser.ie_version;class DOMObserver{constructor(view,onChange,onScrollChanged){this.view=view;this.onChange=onChange;this.onScrollChanged=onScrollChanged;
this.active=!1;this.selectionRange=new DOMSelectionState;this.selectionChanged=!1;this.resizeTimeout=this.delayedFlush=-1;this.queue=[];this.delayedAndroidKey=null;this.scrollTargets=[];this.resize=this.intersection=null;this.intersecting=!1;this.gapIntersection=null;this.gaps=[];this.parentCheck=-1;this.dom=view.contentDOM;this.observer=new MutationObserver(mutations=>{for(let mut of mutations)this.queue.push(mut);(browser.ie&&11>=browser.ie_version||browser.ios&&view.composing)&&mutations.some(m=>
"childList"==m.type&&m.removedNodes.length||"characterData"==m.type&&m.oldValue.length>m.target.nodeValue.length)?this.flushSoon():this.flush()});useCharData&&(this.onCharData=event=>{this.queue.push({target:event.target,type:"characterData",oldValue:event.prevValue});this.flushSoon()});this.onSelectionChange=this.onSelectionChange.bind(this);window.addEventListener("resize",this.onResize=this.onResize.bind(this));"function"==typeof ResizeObserver&&(this.resize=new ResizeObserver(()=>{if(this.view.docView.lastUpdate<
Date.now()-75)this.onResize()}),this.resize.observe(view.scrollDOM));window.addEventListener("beforeprint",this.onPrint=this.onPrint.bind(this));this.start();window.addEventListener("scroll",this.onScroll=this.onScroll.bind(this));"function"==typeof IntersectionObserver&&(this.intersection=new IntersectionObserver(entries=>{0>this.parentCheck&&(this.parentCheck=setTimeout(this.listenForScroll.bind(this),1E3));if(0<entries.length&&0<entries[entries.length-1].intersectionRatio!=this.intersecting&&(this.intersecting=
!this.intersecting,this.intersecting!=this.view.inView))this.onScrollChanged(document.createEvent("Event"))},{}),this.intersection.observe(this.dom),this.gapIntersection=new IntersectionObserver(entries=>{if(0<entries.length&&0<entries[entries.length-1].intersectionRatio)this.onScrollChanged(document.createEvent("Event"))},{}));this.listenForScroll();this.readSelectionRange();this.dom.ownerDocument.addEventListener("selectionchange",this.onSelectionChange)}onScroll(e){this.intersecting&&this.flush(!1);
this.onScrollChanged(e)}onResize(){0>this.resizeTimeout&&(this.resizeTimeout=setTimeout(()=>{this.resizeTimeout=-1;this.view.requestMeasure()},50))}onPrint(){this.view.viewState.printing=!0;this.view.measure();setTimeout(()=>{this.view.viewState.printing=!1;this.view.requestMeasure()},500)}updateGaps(gaps){if(this.gapIntersection&&(gaps.length!=this.gaps.length||this.gaps.some((g,i)=>g!=gaps[i]))){this.gapIntersection.disconnect();for(let gap of gaps)this.gapIntersection.observe(gap);this.gaps=gaps}}onSelectionChange(event){if(this.readSelectionRange()&&
!this.delayedAndroidKey){var {view}=this,sel=this.selectionRange;if(view.state.facet(editable)?view.root.activeElement==this.dom:hasSelection(view.dom,sel)){var context=sel.anchorNode&&view.docView.nearest(sel.anchorNode);context&&context.ignoreEvent(event)||((browser.ie&&11>=browser.ie_version||browser.android&&browser.chrome)&&!view.state.selection.main.empty&&sel.focusNode&&isEquivalentPosition(sel.focusNode,sel.focusOffset,sel.anchorNode,sel.anchorOffset)?this.flushSoon():this.flush(!1))}}}readSelectionRange(){var {root}=
this.view,JSCompiler_temp;if(JSCompiler_temp=browser.safari&&11==root.nodeType){for(JSCompiler_temp=document.activeElement;JSCompiler_temp&&JSCompiler_temp.shadowRoot;)JSCompiler_temp=JSCompiler_temp.shadowRoot.activeElement;JSCompiler_temp=JSCompiler_temp==this.view.contentDOM}root=JSCompiler_temp&&safariSelectionRangeHack(this.view)||getSelection(root);if(!root||this.selectionRange.eq(root))return!1;this.selectionRange.setRange(root);return this.selectionChanged=!0}setSelectionRange(anchor,head){this.selectionRange.set(anchor.node,
anchor.offset,head.node,head.offset);this.selectionChanged=!1}clearSelectionRange(){this.selectionRange.set(null,0,null,0)}listenForScroll(){this.parentCheck=-1;let i=0,changed=null;for(let dom=this.dom;dom;)if(1==dom.nodeType)!changed&&i<this.scrollTargets.length&&this.scrollTargets[i]==dom?i++:changed||(changed=this.scrollTargets.slice(0,i)),changed&&changed.push(dom),dom=dom.assignedSlot||dom.parentNode;else if(11==dom.nodeType)dom=dom.host;else break;i<this.scrollTargets.length&&!changed&&(changed=
this.scrollTargets.slice(0,i));if(changed){for(let dom of this.scrollTargets)dom.removeEventListener("scroll",this.onScroll);for(let dom of this.scrollTargets=changed)dom.addEventListener("scroll",this.onScroll)}}ignore(f){if(!this.active)return f();try{return this.stop(),f()}finally{this.start(),this.clear()}}start(){this.active||(this.observer.observe(this.dom,observeOptions),useCharData&&this.dom.addEventListener("DOMCharacterDataModified",this.onCharData),this.active=!0)}stop(){this.active&&(this.active=
!1,this.observer.disconnect(),useCharData&&this.dom.removeEventListener("DOMCharacterDataModified",this.onCharData))}clear(){this.processRecords();this.queue.length=0;this.selectionChanged=!1}delayAndroidKey(key$jscomp$0,keyCode){this.delayedAndroidKey||requestAnimationFrame(()=>{let key=this.delayedAndroidKey;this.delayedAndroidKey=null;this.delayedFlush=-1;this.flush()||dispatchKey(this.view.contentDOM,key.key,key.keyCode)});this.delayedAndroidKey&&"Enter"!=key$jscomp$0||(this.delayedAndroidKey=
{key:key$jscomp$0,keyCode})}flushSoon(){0>this.delayedFlush&&(this.delayedFlush=window.setTimeout(()=>{this.delayedFlush=-1;this.flush()},20))}forceFlush(){0<=this.delayedFlush&&(window.clearTimeout(this.delayedFlush),this.delayedFlush=-1,this.flush())}processRecords(){var records=this.queue;for(var mut of this.observer.takeRecords())records.push(mut);records.length&&(this.queue=[]);let to=mut=-1,typeOver=!1;for(let record of records)if(records=this.readMutation(record))records.typeOver&&(typeOver=
!0),-1==mut?{from:mut,to}=records:(mut=Math.min(records.from,mut),to=Math.max(records.to,to));return{from:mut,to,typeOver}}flush(readSelection=!0){if(!(0<=this.delayedFlush||this.delayedAndroidKey)){readSelection&&this.readSelectionRange();var {from,to,typeOver}=this.processRecords();readSelection=this.selectionChanged&&hasSelection(this.dom,this.selectionRange);if(!(0>from)||readSelection){this.selectionChanged=!1;readSelection=this.view.state;var handled=this.onChange(from,to,typeOver);this.view.state==
readSelection&&this.view.update([]);return handled}}}readMutation(rec){let cView=this.view.docView.nearest(rec.target);if(!cView||cView.ignoreMutation(rec))return null;cView.markDirty("attributes"==rec.type);"attributes"==rec.type&&(cView.dirty|=4);if("childList"==rec.type){let childBefore=findChild(cView,rec.previousSibling||rec.target.previousSibling,-1);rec=findChild(cView,rec.nextSibling||rec.target.nextSibling,1);return{from:childBefore?cView.posAfter(childBefore):cView.posAtStart,to:rec?cView.posBefore(rec):
cView.posAtEnd,typeOver:!1}}return"characterData"==rec.type?{from:cView.posAtStart,to:cView.posAtEnd,typeOver:rec.target.nodeValue==rec.oldValue}:null}destroy(){var _a,_b,_c;this.stop();null===(_a=this.intersection)||void 0===_a?void 0:_a.disconnect();null===(_b=this.gapIntersection)||void 0===_b?void 0:_b.disconnect();null===(_c=this.resize)||void 0===_c?void 0:_c.disconnect();for(let dom of this.scrollTargets)dom.removeEventListener("scroll",this.onScroll);window.removeEventListener("scroll",this.onScroll);
window.removeEventListener("resize",this.onResize);window.removeEventListener("beforeprint",this.onPrint);this.dom.ownerDocument.removeEventListener("selectionchange",this.onSelectionChange);clearTimeout(this.parentCheck);clearTimeout(this.resizeTimeout)}}class EditorView{constructor(config={}){this.plugins=[];this.pluginMap=new Map;this.editorAttrs={};this.contentAttrs={};this.bidiCache=[];this.destroyed=!1;this.updateState=2;this.measureScheduled=-1;this.measureRequests=[];this.contentDOM=document.createElement("div");
this.scrollDOM=document.createElement("div");this.scrollDOM.tabIndex=-1;this.scrollDOM.className="cm-scroller";this.scrollDOM.appendChild(this.contentDOM);this.announceDOM=document.createElement("div");this.announceDOM.style.cssText="position: absolute; top: -10000px";this.announceDOM.setAttribute("aria-live","polite");this.dom=document.createElement("div");this.dom.appendChild(this.announceDOM);this.dom.appendChild(this.scrollDOM);this._dispatch=config.dispatch||(tr=>this.update([tr]));this.dispatch=
this.dispatch.bind(this);this.root=config.root||getRoot(config.parent)||document;this.viewState=new ViewState(config.state||state$jscomp$0.EditorState.create(config));this.plugins=this.state.facet(viewPlugin).map(spec=>new PluginInstance(spec));for(let plugin of this.plugins)plugin.update(this);this.observer=new DOMObserver(this,(from,to,typeOver)=>applyDOMChange(this,from,to,typeOver),event=>{this.inputState.runScrollHandlers(this,event);this.observer.intersecting&&this.measure()});this.inputState=
new InputState(this);this.inputState.ensureHandlers(this,this.plugins);this.docView=new DocView(this);this.mountStyles();this.updateAttrs();this.updateState=0;this.requestMeasure();config.parent&&config.parent.appendChild(this.dom)}get state(){return this.viewState.state}get viewport(){return this.viewState.viewport}get visibleRanges(){return this.viewState.visibleRanges}get inView(){return this.viewState.inView}get composing(){return 0<this.inputState.composing}get compositionStarted(){return 0<=
...
update=tr$jscomp$0.state}if(this.destroyed)this.viewState.state=update;else{this.observer.clear();if(update.facet(state$jscomp$0.EditorState.phrases)!=this.state.facet(state$jscomp$0.EditorState.phrases))return this.setState(update);update=ViewUpdate.create(this,update,transactions);tr$jscomp$0=this.viewState.scrollTarget;try{this.updateState=2;for(let tr of transactions){tr$jscomp$0&&(tr$jscomp$0=tr$jscomp$0.map(tr.changes));if(tr.scrollIntoView){let {main}=tr.state.selection;tr$jscomp$0=new ScrollTarget(main.empty?
main:state$jscomp$0.EditorSelection.cursor(main.head,main.head>main.anchor?-1:1))}for(let e of tr.effects)e.is(scrollIntoView)&&(tr$jscomp$0=e.value)}this.viewState.update(update,tr$jscomp$0);this.bidiCache=CachedOrder.update(this.bidiCache,update.changes);update.empty||(this.updatePlugins(update),this.inputState.update(update));redrawn=this.docView.update(update);this.state.facet(styleModule)!=this.styleModules&&this.mountStyles();attrsChanged=this.updateAttrs();this.showAnnouncements(transactions);
this.docView.updateSelection(redrawn,transactions.some(tr=>tr.isUserEvent("select.pointer")))}finally{this.updateState=0}update.startState.facet(theme)!=update.state.facet(theme)&&(this.viewState.mustMeasureContent=!0);(redrawn||attrsChanged||tr$jscomp$0||this.viewState.mustEnforceCursorAssoc||this.viewState.mustMeasureContent)&&this.requestMeasure();if(!update.empty)for(let listener of this.state.facet(updateListener))listener(update)}}setState(newState){if(0!=this.updateState)throw Error("Calls to EditorView.setState are not allowed while an update is in progress");
...
this.inputState.ensureHandlers(this,this.plugins)}else for(newPlugins of this.plugins)newPlugins.mustUpdate=update;for(update=0;update<this.plugins.length;update++)this.plugins[update].update(this)}measure(flush=!0){if(!this.destroyed){-1<this.measureScheduled&&cancelAnimationFrame(this.measureScheduled);this.measureScheduled=0;flush&&this.observer.flush();flush=null;try{for(let i$jscomp$0=0;;i$jscomp$0++){this.updateState=1;let oldViewport=this.viewport,changed=this.viewState.measure(this);if(!changed&&
!this.measureRequests.length&&null==this.viewState.scrollTarget)break;if(5<i$jscomp$0){console.warn(this.measureRequests.length?"Measure loop restarted more than 5 times":"Viewport failed to stabilize");break}let measuring=[];changed&4||([this.measureRequests,measuring]=[measuring,this.measureRequests]);let measured=measuring.map(m=>{try{return m.read(this)}catch(e){return logException(this.state,e),BadMeasure}}),update=ViewUpdate.create(this,this.state,[]),redrawn=!1,scrolled=!1;update.flags|=changed;
flush?flush.flags|=changed:flush=update;this.updateState=2;update.empty||(this.updatePlugins(update),this.inputState.update(update),this.updateAttrs(),redrawn=this.docView.update(update));for(let i=0;i<measuring.length;i++)if(measured[i]!=BadMeasure)try{let m=measuring[i];m.write&&m.write(measured[i],this)}catch(e){logException(this.state,e)}this.viewState.scrollTarget&&(this.docView.scrollIntoView(this.viewState.scrollTarget),this.viewState.scrollTarget=null,scrolled=!0);redrawn&&this.docView.updateSelection(!0);
if(this.viewport.from==oldViewport.from&&this.viewport.to==oldViewport.to&&!scrolled&&0==this.measureRequests.length)break}}finally{this.updateState=0,this.measureScheduled=-1}if(flush&&!flush.empty)for(let listener of this.state.facet(updateListener))listener(flush)}}get themeClasses(){return baseThemeID+" "+(this.state.facet(darkTheme)?baseDarkID:baseLightID)+" "+this.state.facet(theme)}updateAttrs(){let editorAttrs=attrsFromFacet(this,editorAttributes,{class:"cm-editor"+(this.hasFocus?" cm-focused ":
" ")+this.themeClasses}),contentAttrs={spellcheck:"false",autocorrect:"off",autocapitalize:"off",translate:"no",contenteditable:this.state.facet(editable)?"true":"false",class:"cm-content",style:`${browser.tabSize}: ${this.state.tabSize}`,role:"textbox","aria-multiline":"true"};this.state.readOnly&&(contentAttrs["aria-readonly"]="true");attrsFromFacet(this,contentAttributes,contentAttrs);let changed=this.observer.ignore(()=>{let changedContent=updateAttrs(this.contentDOM,this.contentAttrs,contentAttrs),
changedEditor=updateAttrs(this.dom,this.editorAttrs,editorAttrs);return changedContent||changedEditor});this.editorAttrs=editorAttrs;this.contentAttrs=contentAttrs;return changed}showAnnouncements(trs){let first=!0;for(let tr of trs)for(let effect of tr.effects)effect.is(EditorView.announce)&&(first&&(this.announceDOM.textContent=""),first=!1,this.announceDOM.appendChild(document.createElement("div")).textContent=effect.value)}mountStyles(){this.styleModules=this.state.facet(styleModule);styleMod.StyleModule.mount(this.root,
this.styleModules.concat(baseTheme$1).reverse())}readMeasured(){if(2==this.updateState)throw Error("Reading the editor layout isn't allowed during an update");0==this.updateState&&-1<this.measureScheduled&&this.measure(!1)}requestMeasure(request){0>this.measureScheduled&&(this.measureScheduled=requestAnimationFrame(()=>this.measure()));if(request){if(null!=request.key)for(let i=0;i<this.measureRequests.length;i++)if(this.measureRequests[i].key===request.key){this.measureRequests[i]=request;return}this.measureRequests.push(request)}}plugin(plugin){let known=
this.pluginMap.get(plugin);(void 0===known||known&&known.spec!=plugin)&&this.pluginMap.set(plugin,known=this.plugins.find(p=>p.spec==plugin)||null);return known&&known.update(this).value}get documentTop(){return this.contentDOM.getBoundingClientRect().top+this.viewState.paddingTop}get documentPadding(){return{top:this.viewState.paddingTop,bottom:this.viewState.paddingBottom}}elementAtHeight(height){this.readMeasured();return this.viewState.elementAtHeight(height)}lineBlockAtHeight(height){this.readMeasured();
return this.viewState.lineBlockAtHeight(height)}get viewportLineBlocks(){return this.viewState.viewportLines}lineBlockAt(pos){return this.viewState.lineBlockAt(pos)}get contentHeight(){return this.viewState.contentHeight}moveByChar(start,forward,by){return skipAtoms(this,start,moveByChar(this,start,forward,by))}moveByGroup(start,forward){return skipAtoms(this,start,moveByChar(this,start,forward,initial=>byGroup(this,start.head,initial)))}moveToLineBoundary(start,forward,includeWrap=!0){a:{let line=
this.state.doc.lineAt(start.head);if(includeWrap=includeWrap&&this.lineWrapping?this.coordsAtPos(0>start.assoc&&start.head>line.from?start.head-1:start.head):null){let editorRect=this.dom.getBoundingClientRect(),direction=this.textDirectionAt(line.from);includeWrap=this.posAtCoords({x:forward==(direction==exports.Direction.LTR)?editorRect.right-1:editorRect.left+1,y:(includeWrap.top+includeWrap.bottom)/2});if(null!=includeWrap){forward=state$jscomp$0.EditorSelection.cursor(includeWrap,forward?-1:
1);break a}}start=LineView.find(this.docView,start.head);forward=state$jscomp$0.EditorSelection.cursor(start?forward?start.posAtEnd:start.posAtStart:forward?line.to:line.from,forward?-1:1)}return forward}moveVertically(start,forward,distance){a:{var JSCompiler_inline_result=start.head;let dir=forward?1:-1;if(JSCompiler_inline_result==(forward?this.state.doc.length:0))JSCompiler_inline_result=state$jscomp$0.EditorSelection.cursor(JSCompiler_inline_result,start.assoc);else{forward=start.goalColumn;
var rect=this.contentDOM.getBoundingClientRect(),startCoords=this.coordsAtPos(JSCompiler_inline_result);var startY=this.documentTop;startCoords?(null==forward&&(forward=startCoords.left-rect.left),startY=0>dir?startCoords.top:startCoords.bottom):(startCoords=this.viewState.lineBlockAt(JSCompiler_inline_result),null==forward&&(forward=Math.min(rect.right-rect.left,this.defaultCharacterWidth*(JSCompiler_inline_result-startCoords.from))),startY=(0>dir?startCoords.top:startCoords.bottom)+startY);startCoords=
rect.left+forward;distance=null!==distance&&void 0!==distance?distance:this.defaultLineHeight>>1;for(let extra=0;;extra+=10){let curY=startY+(distance+extra)*dir,pos=posAtCoords(this,{x:startCoords,y:curY},!1,dir);if(curY<rect.top||curY>rect.bottom||(0>dir?pos<JSCompiler_inline_result:pos>JSCompiler_inline_result)){JSCompiler_inline_result=state$jscomp$0.EditorSelection.cursor(pos,start.assoc,void 0,forward);break a}}}}return skipAtoms(this,start,JSCompiler_inline_result)}domAtPos(pos){return this.docView.domAtPos(pos)}posAtDOM(node,
offset=0){return this.docView.posFromDOM(node,offset)}posAtCoords(coords,precise=!0){this.readMeasured();return posAtCoords(this,coords,precise)}coordsAtPos(pos,side=1){this.readMeasured();let rect=this.docView.coordsAt(pos,side);if(!rect||rect.left==rect.right)return rect;let line=this.state.doc.lineAt(pos),order=this.bidiSpans(line);pos=order[BidiSpan.find(order,pos-line.from,-1,side)];return flattenRect(rect,pos.dir==exports.Direction.LTR==0<side)}get defaultCharacterWidth(){return this.viewState.heightOracle.charWidth}get defaultLineHeight(){return this.viewState.heightOracle.lineHeight}get textDirection(){return this.viewState.defaultTextDirection}textDirectionAt(pos){if(!this.state.facet(perLineTextDirection)||
pos<this.viewport.from||pos>this.viewport.to)return this.textDirection;this.readMeasured();return this.docView.textDirectionAt(pos)}get lineWrapping(){return this.viewState.heightOracle.lineWrapping}bidiSpans(line){if(4096<line.length)return[new BidiSpan(0,line.length,0)];let dir=this.textDirectionAt(line.from);for(var entry of this.bidiCache)if(entry.from==line.from&&entry.dir==dir)return entry.order;entry=computeOrder(line.text,dir);this.bidiCache.push(new CachedOrder(line.from,line.to,dir,entry));
return entry}get hasFocus(){var _a;return(document.hasFocus()||browser.safari&&(null===(_a=this.inputState)||void 0===_a?void 0:_a.lastContextMenu)>Date.now()-3E4)&&this.root.activeElement==this.contentDOM}focus(){this.observer.ignore(()=>{focusPreventScroll(this.contentDOM);this.docView.updateSelection()})}destroy(){for(let plugin of this.plugins)plugin.destroy(this);this.plugins=[];this.inputState.destroy();this.dom.remove();this.observer.destroy();-1<this.measureScheduled&&cancelAnimationFrame(this.measureScheduled);
this.destroyed=!0}static scrollIntoView(pos,options={}){return scrollIntoView.of(new ScrollTarget("number"==typeof pos?state$jscomp$0.EditorSelection.cursor(pos):pos,options.y,options.x,options.yMargin,options.xMargin))}static domEventHandlers(handlers){return ViewPlugin.define(()=>({}),{eventHandlers:handlers})}static theme(spec,options){let prefix=styleMod.StyleModule.newName();spec=[theme.of(prefix),styleModule.of(buildTheme(`.${prefix}`,spec))];options&&options.dark&&spec.push(darkTheme.of(!0));
return spec}static baseTheme(spec){return state$jscomp$0.Prec.lowest(styleModule.of(buildTheme("."+baseThemeID,spec,lightDarkIDs)))}static findFromDOM(dom){var _a;let content=dom.querySelector(".cm-content");dom=content&&ContentView.get(content)||ContentView.get(dom);return(null===(_a=null===dom||void 0===dom?void 0:dom.rootView)||void 0===_a?void 0:_a.view)||null}}EditorView.styleModule=styleModule;EditorView.inputHandler=inputHandler;EditorView.perLineTextDirection=perLineTextDirection;EditorView.exceptionSink=
exceptionSink;EditorView.updateListener=updateListener;EditorView.editable=editable;EditorView.mouseSelectionStyle=mouseSelectionStyle;EditorView.dragMovesSelection=dragMovesSelection$1;EditorView.clickAddsSelectionRange=clickAddsSelectionRange;EditorView.decorations=decorations;EditorView.atomicRanges=atomicRanges;EditorView.scrollMargins=scrollMargins;EditorView.darkTheme=darkTheme;EditorView.contentAttributes=contentAttributes;EditorView.editorAttributes=editorAttributes;EditorView.lineWrapping=
EditorView.contentAttributes.of({"class":"cm-lineWrapping"});EditorView.announce=state$jscomp$0.StateEffect.define();const BadMeasure={};class CachedOrder{constructor(from,to,dir,order){this.from=from;this.to=to;this.dir=dir;this.order=order}static update(cache,changes){if(changes.empty)return cache;let result=[],lastDir=cache.length?cache[cache.length-1].dir:exports.Direction.LTR;for(let i=Math.max(0,cache.length-10);i<cache.length;i++){let entry=cache[i];entry.dir!=lastDir||changes.touchesRange(entry.from,
entry.to)||result.push(new CachedOrder(changes.mapPos(entry.from,1),changes.mapPos(entry.to,-1),entry.dir,entry.order))}return result}}const currentPlatform=browser.mac?"mac":browser.windows?"win":browser.linux?"linux":"key",handleKeyEvents=EditorView.domEventHandlers({keydown(event,view){return runHandlers(getKeymap(view.state),event,view,"editor")}}),keymap=state$jscomp$0.Facet.define({enables:handleKeyEvents}),Keymaps=new WeakMap;let storedPrefix=null;const CanHidePrimary=!browser.ios,selectionConfig=
state$jscomp$0.Facet.define({combine(configs){return state$jscomp$0.combineConfig(configs,{cursorBlinkRate:1200,drawRangeCursor:!0},{cursorBlinkRate:(a,b)=>Math.min(a,b),drawRangeCursor:(a,b)=>a||b})}});class Piece{constructor(left,top,width,height,className){this.left=left;this.top=top;this.width=width;this.height=height;this.className=className}draw(){let elt=document.createElement("div");elt.className=this.className;this.adjust(elt);return elt}adjust(elt){elt.style.left=this.left+"px";elt.style.top=
this.top+"px";0<=this.width&&(elt.style.width=this.width+"px");elt.style.height=this.height+"px"}eq(p){return this.left==p.left&&this.top==p.top&&this.width==p.width&&this.height==p.height&&this.className==p.className}}const drawSelectionPlugin=ViewPlugin.fromClass(class{constructor(view){this.view=view;this.rangePieces=[];this.cursors=[];this.measureReq={read:this.readPos.bind(this),write:this.drawSel.bind(this)};this.selectionLayer=view.scrollDOM.appendChild(document.createElement("div"));this.selectionLayer.className=
"cm-selectionLayer";this.selectionLayer.setAttribute("aria-hidden","true");this.cursorLayer=view.scrollDOM.appendChild(document.createElement("div"));this.cursorLayer.className="cm-cursorLayer";this.cursorLayer.setAttribute("aria-hidden","true");view.requestMeasure(this.measureReq);this.setBlinkRate()}setBlinkRate(){this.cursorLayer.style.animationDuration=this.view.state.facet(selectionConfig).cursorBlinkRate+"ms"}update(update){let confChanged=update.startState.facet(selectionConfig)!=update.state.facet(selectionConfig);
(confChanged||update.selectionSet||update.geometryChanged||update.viewportChanged)&&this.view.requestMeasure(this.measureReq);update.transactions.some(tr=>tr.scrollIntoView)&&(this.cursorLayer.style.animationName="cm-blink"==this.cursorLayer.style.animationName?"cm-blink2":"cm-blink");confChanged&&this.setBlinkRate()}readPos(){let {state}=this.view,conf=state.facet(selectionConfig),rangePieces=state.selection.ranges.map(r=>r.empty?[]:measureRange(this.view,r)).reduce((a,b)=>a.concat(b)),cursors=[];
for(let r of state.selection.ranges){var prim=r==state.selection.main;(r.empty?!prim||CanHidePrimary:conf.drawRangeCursor)&&(prim=measureCursor(this.view,r,prim))&&cursors.push(prim)}return{rangePieces,cursors}}drawSel({rangePieces,cursors}){if(rangePieces.length!=this.rangePieces.length||rangePieces.some((p,i)=>!p.eq(this.rangePieces[i]))){this.selectionLayer.textContent="";for(let p of rangePieces)this.selectionLayer.appendChild(p.draw());this.rangePieces=rangePieces}if(cursors.length!=this.cursors.length||
cursors.some((c,i)=>!c.eq(this.cursors[i]))){let oldCursors=this.cursorLayer.children;if(oldCursors.length!==cursors.length){this.cursorLayer.textContent="";for(const c of cursors)this.cursorLayer.appendChild(c.draw())}else cursors.forEach((c,idx)=>c.adjust(oldCursors[idx]));this.cursors=cursors}}destroy(){this.selectionLayer.remove();this.cursorLayer.remove()}}),themeSpec={".cm-line":{"\x26 ::selection":{backgroundColor:"transparent !important"},"\x26::selection":{backgroundColor:"transparent !important"}}};
CanHidePrimary&&(themeSpec[".cm-line"].caretColor="transparent !important");const hideNativeSelection=state$jscomp$0.Prec.highest(EditorView.theme(themeSpec)),setDropCursorPos=state$jscomp$0.StateEffect.define({map(pos,mapping){return null==pos?null:mapping.mapPos(pos)}}),dropCursorPos=state$jscomp$0.StateField.define({create(){return null},update(pos$jscomp$0,tr){null!=pos$jscomp$0&&(pos$jscomp$0=tr.changes.mapPos(pos$jscomp$0));return tr.effects.reduce((pos,e)=>e.is(setDropCursorPos)?e.value:pos,
pos$jscomp$0)}}),drawDropCursor=ViewPlugin.fromClass(class{constructor(view){this.view=view;this.cursor=null;this.measureReq={read:this.readPos.bind(this),write:this.drawCursor.bind(this)}}update(update){var _a;let cursorPos=update.state.field(dropCursorPos);null==cursorPos?null!=this.cursor&&(null===(_a=this.cursor)||void 0===_a?void 0:_a.remove(),this.cursor=null):(this.cursor||(this.cursor=this.view.scrollDOM.appendChild(document.createElement("div")),this.cursor.className="cm-dropCursor"),(update.startState.field(dropCursorPos)!=
cursorPos||update.docChanged||update.geometryChanged)&&this.view.requestMeasure(this.measureReq))}readPos(){var pos=this.view.state.field(dropCursorPos);pos=null!=pos&&this.view.coordsAtPos(pos);if(!pos)return null;let outer=this.view.scrollDOM.getBoundingClientRect();return{left:pos.left-outer.left+this.view.scrollDOM.scrollLeft,top:pos.top-outer.top+this.view.scrollDOM.scrollTop,height:pos.bottom-pos.top}}drawCursor(pos){this.cursor&&(pos?(this.cursor.style.left=pos.left+"px",this.cursor.style.top=
pos.top+"px",this.cursor.style.height=pos.height+"px"):this.cursor.style.left="-100000px")}destroy(){this.cursor&&this.cursor.remove()}setDropPos(pos){this.view.state.field(dropCursorPos)!=pos&&this.view.dispatch({effects:setDropCursorPos.of(pos)})}},{eventHandlers:{dragover(event){this.setDropPos(this.view.posAtCoords({x:event.clientX,y:event.clientY}))},dragleave(event){event.target!=this.view.contentDOM&&this.view.contentDOM.contains(event.relatedTarget)||this.setDropPos(null)},dragend(){this.setDropPos(null)},
drop(){this.setDropPos(null)}}});class MatchDecorator{constructor(config){let {regexp,decoration,boundary,maxLength=1E3}=config;if(!regexp.global)throw new RangeError("The regular expression given to MatchDecorator should have its 'g' flag set");this.regexp=regexp;this.getDeco="function"==typeof decoration?decoration:()=>decoration;this.boundary=boundary;this.maxLength=maxLength}createDeco(view){let build=new state$jscomp$0.RangeSetBuilder;for(let {from,to}of matchRanges(view,this.maxLength))iterMatches(view.state.doc,
this.regexp,from,to,(a,b,m)=>build.add(a,b,this.getDeco(m,view,a)));return build.finish()}updateDeco(update,deco){let changeFrom=1E9,changeTo=-1;update.docChanged&&update.changes.iterChanges((_f,_t,from,to)=>{to>update.view.viewport.from&&from<update.view.viewport.to&&(changeFrom=Math.min(from,changeFrom),changeTo=Math.max(to,changeTo))});return update.viewportChanged||1E3<changeTo-changeFrom?this.createDeco(update.view):-1<changeTo?this.updateRange(update.view,deco.map(update.changes),changeFrom,
changeTo):deco}updateRange(view,deco,updateFrom,updateTo){for(let r of view.visibleRanges){var from$jscomp$0=Math.max(r.from,updateFrom);let to$jscomp$0=Math.min(r.to,updateTo);if(to$jscomp$0>from$jscomp$0){let fromLine=view.state.doc.lineAt(from$jscomp$0),toLine=fromLine.to<to$jscomp$0?view.state.doc.lineAt(to$jscomp$0):fromLine,start=Math.max(r.from,fromLine.from),end=Math.min(r.to,toLine.to);if(this.boundary){for(;from$jscomp$0>fromLine.from;from$jscomp$0--)if(this.boundary.test(fromLine.text[from$jscomp$0-
...
else iterMatches(view.state.doc,this.regexp,start,end,(from,to,m)=>ranges.push(this.getDeco(m,view,from).range(from,to)));deco=deco.update({filterFrom:start,filterTo:end,filter:(from,to)=>from<start||to>end,add:ranges})}}return deco}}const UnicodeRegexpSupport=null!=/x/.unicode?"gu":"g",Specials=RegExp("[\x00-\b\n--­؜​‎‏\u2028\u2029‭‮﻿￹-￼]",UnicodeRegexpSupport),Names={0:"null",7:"bell",8:"backspace",10:"newline",11:"vertical tab",13:"carriage return",27:"escape",8203:"zero width space",8204:"zero width non-joiner",
8205:"zero width joiner",8206:"left-to-right mark",8207:"right-to-left mark",8232:"line separator",8237:"left-to-right override",8238:"right-to-left override",8233:"paragraph separator",65279:"zero width no-break space",65532:"object replacement"};let _supportsTabSize=null;const specialCharConfig=state$jscomp$0.Facet.define({combine(configs){configs=state$jscomp$0.combineConfig(configs,{render:null,specialChars:Specials,addSpecialChars:null});var _a;if(null==_supportsTabSize&&"undefined"!=typeof document&&
document.body){let styles=document.body.style;_supportsTabSize=null!=(null!==(_a=styles.tabSize)&&void 0!==_a?_a:styles.MozTabSize)}if(configs.replaceTabs=!_supportsTabSize)configs.specialChars=new RegExp("\t|"+configs.specialChars.source,UnicodeRegexpSupport);configs.addSpecialChars&&(configs.specialChars=new RegExp(configs.specialChars.source+"|"+configs.addSpecialChars.source,UnicodeRegexpSupport));return configs}});let _plugin=null;class SpecialCharWidget extends WidgetType{constructor(options,
code){super();this.options=options;this.code=code}eq(other){return other.code==this.code}toDOM(view){var JSCompiler_inline_result=this.code;JSCompiler_inline_result=32<=JSCompiler_inline_result?"•":10==JSCompiler_inline_result?"␤":String.fromCharCode(9216+JSCompiler_inline_result);view=view.state.phrase("Control character")+" "+(Names[this.code]||"0x"+this.code.toString(16));var custom=this.options.render&&this.options.render(this.code,view,JSCompiler_inline_result);if(custom)return custom;custom=
document.createElement("span");custom.textContent=JSCompiler_inline_result;custom.title=view;custom.setAttribute("aria-label",view);custom.className="cm-specialChar";return custom}ignoreEvent(){return!1}}class TabWidget extends WidgetType{constructor(width){super();this.width=width}eq(other){return other.width==this.width}toDOM(){let span=document.createElement("span");span.textContent="\t";span.className="cm-tab";span.style.width=this.width+"px";return span}ignoreEvent(){return!1}}const plugin=ViewPlugin.fromClass(class{constructor(){this.height=
1E3;this.attrs={style:"padding-bottom: 1000px"}}update(update){update=update.view.viewState.editorHeight-update.view.defaultLineHeight;update!=this.height&&(this.height=update,this.attrs={style:`padding-bottom: ${update}px`})}}),lineDeco=Decoration.line({class:"cm-activeLine"}),activeLineHighlighter=ViewPlugin.fromClass(class{constructor(view){this.decorations=this.getDeco(view)}update(update){if(update.docChanged||update.selectionSet)this.decorations=this.getDeco(update.view)}getDeco(view){let lastLineStart=
...
document.createTextNode(this.content):this.content);"string"==typeof this.content?wrap.setAttribute("aria-label","placeholder "+this.content):wrap.setAttribute("aria-hidden","true");return wrap}ignoreEvent(){return!1}}const keys={Alt:[18,e=>e.altKey],Control:[17,e=>e.ctrlKey],Shift:[16,e=>e.shiftKey],Meta:[91,e=>e.metaKey]},showCrosshair={style:"cursor: crosshair"};class TooltipViewManager{constructor(view,facet,createTooltipView){this.facet=facet;this.createTooltipView=createTooltipView;this.input=
view.state.facet(facet);this.tooltips=this.input.filter(t=>t);this.tooltipViews=this.tooltips.map(createTooltipView)}update(update){let input=update.state.facet(this.facet),tooltips=input.filter(x=>x);if(input===this.input){for(var t$jscomp$0 of this.tooltipViews)t$jscomp$0.update&&t$jscomp$0.update(update);return!1}t$jscomp$0=[];for(let i$jscomp$0=0;i$jscomp$0<tooltips.length;i$jscomp$0++){var tip=tooltips[i$jscomp$0];let known=-1;if(tip){for(let i=0;i<this.tooltips.length;i++){let other=this.tooltips[i];
other&&other.create==tip.create&&(known=i)}0>known?t$jscomp$0[i$jscomp$0]=this.createTooltipView(tip):(tip=t$jscomp$0[i$jscomp$0]=this.tooltipViews[known],tip.update&&tip.update(update))}}for(let t of this.tooltipViews)0>t$jscomp$0.indexOf(t)&&t.dom.remove();this.input=input;this.tooltips=tooltips;this.tooltipViews=t$jscomp$0;return!0}}const tooltipConfig=state$jscomp$0.Facet.define({combine:values=>{var _a,_b,_c;return{position:browser.ios?"absolute":(null===(_a=values.find(conf=>conf.position))||
void 0===_a?void 0:_a.position)||"fixed",parent:(null===(_b=values.find(conf=>conf.parent))||void 0===_b?void 0:_b.parent)||null,tooltipSpace:(null===(_c=values.find(conf=>conf.tooltipSpace))||void 0===_c?void 0:_c.tooltipSpace)||windowSpace}}}),tooltipPlugin=ViewPlugin.fromClass(class{constructor(view){var _a;this.view=view;this.inView=!0;this.lastTransaction=0;this.measureTimeout=-1;let config=view.state.facet(tooltipConfig);this.position=config.position;this.parent=config.parent;this.classes=view.themeClasses;
this.createContainer();this.measureReq={read:this.readMeasure.bind(this),write:this.writeMeasure.bind(this),key:this};this.manager=new TooltipViewManager(view,showTooltip,t=>this.createTooltip(t));this.intersectionObserver="function"==typeof IntersectionObserver?new IntersectionObserver(entries=>{Date.now()>this.lastTransaction-50&&0<entries.length&&1>entries[entries.length-1].intersectionRatio&&this.measureSoon()},{threshold:[1]}):null;this.observeIntersection();null===(_a=view.dom.ownerDocument.defaultView)||
void 0===_a?void 0:_a.addEventListener("resize",this.measureSoon=this.measureSoon.bind(this));this.maybeMeasure()}createContainer(){this.parent?(this.container=document.createElement("div"),this.container.style.position="relative",this.container.className=this.view.themeClasses,this.parent.appendChild(this.container)):this.container=this.view.dom}observeIntersection(){if(this.intersectionObserver){this.intersectionObserver.disconnect();for(let tooltip of this.manager.tooltipViews)this.intersectionObserver.observe(tooltip.dom)}}measureSoon(){0>
...
(tooltip=document.createElement("div"),tooltip.className="cm-tooltip-arrow",tooltipView.dom.appendChild(tooltip));tooltipView.dom.style.position=this.position;tooltipView.dom.style.top="-10000px";this.container.appendChild(tooltipView.dom);tooltipView.mount&&tooltipView.mount(this.view);return tooltipView}destroy(){var _a,_b;null===(_a=this.view.dom.ownerDocument.defaultView)||void 0===_a?void 0:_a.removeEventListener("resize",this.measureSoon);for(let {dom}of this.manager.tooltipViews)dom.remove();
null===(_b=this.intersectionObserver)||void 0===_b?void 0:_b.disconnect();clearTimeout(this.measureTimeout)}readMeasure(){let editor=this.view.dom.getBoundingClientRect();return{editor,parent:this.parent?this.container.getBoundingClientRect():editor,pos:this.manager.tooltips.map((t,i)=>{i=this.manager.tooltipViews[i];return i.getCoords?i.getCoords(t.pos):this.view.coordsAtPos(t.pos)}),size:this.manager.tooltipViews.map(({dom})=>dom.getBoundingClientRect()),space:this.view.state.facet(tooltipConfig).tooltipSpace(this.view)}}writeMeasure(measured){let {editor,
space}=measured,others=[];for(let i=0;i<this.manager.tooltips.length;i++){var tooltip=this.manager.tooltips[i];let tView=this.manager.tooltipViews[i],{dom}=tView,pos=measured.pos[i],size=measured.size[i];if(!pos||pos.bottom<=Math.max(editor.top,space.top)||pos.top>=Math.min(editor.bottom,space.bottom)||pos.right<Math.max(editor.left,space.left)-.1||pos.left>Math.min(editor.right,space.right)+.1){dom.style.top="-10000px";continue}let arrow=tooltip.arrow?tView.dom.querySelector(".cm-tooltip-arrow"):
null,arrowHeight=arrow?7:0;var width=size.right-size.left;let height=size.bottom-size.top,offset=tView.offset||noOffset,ltr=this.view.textDirection==exports.Direction.LTR,left=size.width>space.right-space.left?ltr?space.left:space.right-size.width:ltr?Math.min(pos.left-(arrow?14:0)+offset.x,space.right-width):Math.max(space.left,pos.left-width+(arrow?14:0)-offset.x),above=!!tooltip.above;!tooltip.strictSide&&(above?pos.top-(size.bottom-size.top)-offset.y<space.top:pos.bottom+(size.bottom-size.top)+
offset.y>space.bottom)&&above==space.bottom-pos.bottom>pos.top-space.top&&(above=!above);tooltip=above?pos.top-height-arrowHeight-offset.y:pos.bottom+arrowHeight+offset.y;width=left+width;if(!0!==tView.overlap)for(let r of others)r.left<width&&r.right>left&&r.top<tooltip+height&&r.bottom>tooltip&&(tooltip=above?r.top-height-2-arrowHeight:r.bottom+arrowHeight+2);"absolute"==this.position?(dom.style.top=tooltip-measured.parent.top+"px",dom.style.left=left-measured.parent.left+"px"):(dom.style.top=tooltip+
"px",dom.style.left=left+"px");arrow&&(arrow.style.left=`${pos.left+(ltr?offset.x:-offset.x)-(left+14-7)}px`);!0!==tView.overlap&&others.push({left,top:tooltip,right:width,bottom:tooltip+height});dom.classList.toggle("cm-tooltip-above",above);dom.classList.toggle("cm-tooltip-below",!above);tView.positioned&&tView.positioned()}}maybeMeasure(){if(this.manager.tooltips.length&&(this.view.inView&&this.view.requestMeasure(this.measureReq),this.inView!=this.view.inView&&(this.inView=this.view.inView,!this.inView)))for(let tv of this.manager.tooltipViews)tv.dom.style.top=
