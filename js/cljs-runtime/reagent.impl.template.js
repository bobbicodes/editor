...
var G__58438 = o;
goog.object.set(G__58438,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__58484__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__58484 = function (var_args){
var args = null;
...
while (G__58485__i < G__58485__a.length) {G__58485__a[G__58485__i] = arguments[G__58485__i + 0]; ++G__58485__i;}
  args = new cljs.core.IndexedSeq(G__58485__a,0,null);
} 
return G__58484__delegate.call(this,args);};
G__58484.cljs$lang$maxFixedArity = 0;
G__58484.cljs$lang$applyTo = (function (arglist__58486){
var args = cljs.core.seq(arglist__58486);
return G__58484__delegate(args);
});
G__58484.cljs$core$IFn$_invoke$arity$variadic = G__58484__delegate;
return G__58484;
})()
;
} else {
...
var G__58439 = o;
goog.object.set(G__58439,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__58487__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__58487 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58488__i = 0, G__58488__a = new Array(arguments.length -  0);
while (G__58488__i < G__58488__a.length) {G__58488__a[G__58488__i] = arguments[G__58488__i + 0]; ++G__58488__i;}
  args = new cljs.core.IndexedSeq(G__58488__a,0,null);
} 
return G__58487__delegate.call(this,args);};
G__58487.cljs$lang$maxFixedArity = 0;
G__58487.cljs$lang$applyTo = (function (arglist__58489){
var args = cljs.core.seq(arglist__58489);
return G__58487__delegate(args);
});
...
var G__58443 = props;
var G__58443__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58443,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__58443);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58443__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__58444 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58444,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__58444;
}
})(),id_class);
...
var G__58445 = (cljs.core.count(argv) - first_child);
switch (G__58445) {
case (0):
...
var vec__58452 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58452,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58452,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58452,(2),null);
...
var temp__5757__auto___58491 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___58491 == null)){
} else {
var key_58492 = temp__5757__auto___58491;
(jsprops.key = key_58492);
}
...
var temp__5757__auto___58493 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___58493 == null)){
} else {
var key_58494 = temp__5757__auto___58493;
(jsprops.key = key_58494);
}
...
var temp__5757__auto___58495 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___58495 == null)){
} else {
var key_58496 = temp__5757__auto___58495;
(jsprops.key = key_58496);
}
...
var temp__5757__auto___58511 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___58511 == null)){
} else {
var key_58512 = temp__5757__auto___58511;
(jsprops.key = key_58512);
}
...
var temp__5757__auto___58514 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___58514 == null)){
} else {
var key_58515 = temp__5757__auto___58514;
(jsprops.key = key_58515);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58460_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__58460_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__58461 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58461,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58461,(1),null);
...
break;
default:
var G__58530 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__58531 = compiler;
v = G__58530;
compiler = G__58531;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template58479 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template58479 = (function (opts,id,fn_to_element,parse_fn,meta58480){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template58479.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58481,meta58480__$1){
var self__ = this;
var _58481__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template58479(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta58480__$1));
}));

(reagent.impl.template.t_reagent$impl$template58479.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58481){
var self__ = this;
var _58481__$1 = this;
return self__.meta58480;
}));

(reagent.impl.template.t_reagent$impl$template58479.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template58479.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template58479.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template58479.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template58479.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template58479.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta58480","meta58480",-1167927861,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template58479.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template58479.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template58479");

(reagent.impl.template.t_reagent$impl$template58479.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template58479");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template58479.
 */
reagent.impl.template.__GT_t_reagent$impl$template58479 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template58479(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta58480){
return (new reagent.impl.template.t_reagent$impl$template58479(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta58480));
});

}

return (new reagent.impl.template.t_reagent$impl$template58479(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
