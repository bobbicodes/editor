...
var G__58117 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__58117 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__58117,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__58118 = cljs.core.seq(lvls);
var chunk__58120 = null;
var count__58121 = (0);
var i__58122 = (0);
while(true){
if((i__58122 < count__58121)){
var vec__58130 = chunk__58120.cljs$core$IIndexed$_nth$arity$2(null,i__58122);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58130,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58130,(1),null);
var level_58230__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_58230__$1);


var G__58231 = seq__58118;
var G__58232 = chunk__58120;
var G__58233 = count__58121;
var G__58234 = (i__58122 + (1));
seq__58118 = G__58231;
chunk__58120 = G__58232;
count__58121 = G__58233;
i__58122 = G__58234;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__58118);
if(temp__5753__auto__){
var seq__58118__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__58118__$1)){
var c__4649__auto__ = cljs.core.chunk_first(seq__58118__$1);
var G__58235 = cljs.core.chunk_rest(seq__58118__$1);
var G__58236 = c__4649__auto__;
var G__58237 = cljs.core.count(c__4649__auto__);
var G__58238 = (0);
seq__58118 = G__58235;
chunk__58120 = G__58236;
count__58121 = G__58237;
i__58122 = G__58238;
continue;
} else {
var vec__58133 = cljs.core.first(seq__58118__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58133,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58133,(1),null);
var level_58239__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_58239__$1);


var G__58240 = cljs.core.next(seq__58118__$1);
var G__58241 = null;
var G__58242 = (0);
var G__58243 = (0);
seq__58118 = G__58240;
chunk__58120 = G__58241;
count__58121 = G__58242;
i__58122 = G__58243;
continue;
}
} else {
...
var temp__5753__auto___58244 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5753__auto___58244)){
var instance_58245 = temp__5753__auto___58244;
instance_58245.setCapturing(true);

var instance_58246__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_58246__$1);

instance_58246__$1.setCapturing();
} else {
}
...
var G__58211 = (new goog.debug.FancyWindow());
G__58211.setEnabled(true);
...
var G__58212 = (new goog.debug.DivConsole(element));
G__58212.setCapturing(true);
...
var len__4829__auto___58247 = arguments.length;
var i__4830__auto___58248 = (0);
while(true){
if((i__4830__auto___58248 < len__4829__auto___58247)){
args__4835__auto__.push((arguments[i__4830__auto___58248]));

var G__58249 = (i__4830__auto___58248 + (1));
i__4830__auto___58248 = G__58249;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq58213){
var G__58214 = cljs.core.first(seq58213);
var seq58213__$1 = cljs.core.next(seq58213);
var G__58215 = cljs.core.first(seq58213__$1);
var seq58213__$2 = cljs.core.next(seq58213__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58214,G__58215,seq58213__$2);
}));
...
var G__58219 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__58219) : handler_fn.call(null,G__58219));
});
if(cljs.core.truth_(logger)){
var temp__5753__auto___58271 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___58271)){
var handler_58272 = temp__5753__auto___58271;
lambdaisland.glogi.goog_removeHandler(logger,handler_58272);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__58220,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5753__auto___58275 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___58275)){
var handler_58276 = temp__5753__auto___58275;
lambdaisland.glogi.goog_removeHandler(logger,handler_58276);
} else {
}
