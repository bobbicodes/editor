...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56786_SHARP_){
return ["%",lambdaisland.uri.platform.byte__GT_hex(p1__56786_SHARP_)].join('');
...
var encode_char = (function (p1__56787_SHARP_){
var G__56790 = p1__56787_SHARP_;
if(cljs.core.truth_(cljs.core.re_find(char_class,p1__56787_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(G__56790);
} else {
return G__56790;
}
});
...
return clojure.string.replace(s,/(%[0-9A-Fa-f]{2})+/,(function (p__56795){
var vec__56796 = p__56795;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56796,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56796,(1),null);
...
var G__56887 = (i + (3));
var G__56888 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.normalize.percent_decode(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (3)))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__56887;
res = G__56888;
continue;
} else {
...
var G__56889 = (i + (1));
var G__56890 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))));
i = G__56889;
res = G__56890;
continue;
} else {
var increment = ((lambdaisland.uri.normalize.high_surrogate_QMARK_(lambdaisland.uri.platform.char_code_at(s,i)))?(2):(1));
var G__56892 = (i + increment);
var G__56893 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + increment)),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__56892;
res = G__56893;
continue;
