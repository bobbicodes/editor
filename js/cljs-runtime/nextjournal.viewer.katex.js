...
var G__60619 = content;
var G__60619__$1 = (((G__60619 == null))?null:clojure.string.replace(G__60619,/\\(begin|end)\{(align|eqnarray)\*?\}/,"\\$1{aligned}"));
var G__60619__$2 = (((G__60619__$1 == null))?null:clojure.string.replace(G__60619__$1,/\\(begin|end)\{equation[^}]*?\}/,""));
var G__60619__$3 = (((G__60619__$2 == null))?null:clojure.string.replace(G__60619__$2,/\\mbox\{/,"\\textrm{"));
var G__60619__$4 = (((G__60619__$3 == null))?null:clojure.string.replace(G__60619__$3,/\\label/,""));
if((G__60619__$4 == null)){
return null;
} else {
return clojure.string.replace(G__60619__$4,/\\\\\\\n/,"\\\\\n");
}
});
nextjournal.viewer.katex.to_html_string = (function nextjournal$viewer$katex$to_html_string(var_args){
var G__60621 = arguments.length;
switch (G__60621) {
case 1:
