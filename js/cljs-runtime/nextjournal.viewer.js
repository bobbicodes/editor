...
var G__61855 = tag;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"var","var",870848730,null),G__61855)){
return new cljs.core.Keyword(null,"edn-var","edn-var",-1138947582);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"object","object",-1179821820,null),G__61855)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol("nextjournal","empty","nextjournal/empty",2001390345,null),G__61855)){
...
var nextjournal$viewer$ITypeKey$_type_key$dyn_62125 = (function (x){
var x__4521__auto__ = (((x == null))?null:x);
var m__4522__auto__ = (nextjournal.viewer._type_key[goog.typeOf(x__4521__auto__)]);
...
var m__4519__auto__ = (nextjournal.viewer._type_key["_"]);
...
return nextjournal$viewer$ITypeKey$_type_key$dyn_62125(x);
}
});
...
if(cljs.core.truth_((function (){var and__4221__auto__ = cognitect.transit.tagged_value_QMARK_(value);
...
var map__61859 = nextjournal.viewer.color_classes(selected_QMARK_);
var map__61859__$1 = cljs.core.__destructure_map(map__61859);
var badge_background_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61859__$1,new cljs.core.Keyword(null,"badge-background-color","badge-background-color",1563868990));
var label_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61859__$1,new cljs.core.Keyword(null,"label-color","label-color",813573617));
...
nextjournal.viewer.more_button = (function nextjournal$viewer$more_button(visible_nb_items_ratom,p__61860){
var map__61861 = p__61860;
var map__61861__$1 = cljs.core.__destructure_map(map__61861);
var _opts = map__61861__$1;
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61861__$1,new cljs.core.Keyword(null,"expanded?","expanded?",2055832296));
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61861__$1,new cljs.core.Keyword(null,"count","count",2139924085));
...
nextjournal.viewer.browsify_button = (function nextjournal$viewer$browsify_button(path,p__61862,view){
var map__61863 = p__61862;
var map__61863__$1 = cljs.core.__destructure_map(map__61863);
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61863__$1,new cljs.core.Keyword("nextjournal","dispatch","nextjournal/dispatch",-950337451));
...
var G__61864 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"kind","kind",-717265803),new cljs.core.Keyword(null,"nav","nav",719540477),new cljs.core.Keyword(null,"path","path",-188191168),path], null);
return (dispatch.cljs$core$IFn$_invoke$arity$1 ? dispatch.cljs$core$IFn$_invoke$arity$1(G__61864) : dispatch.call(null,G__61864));
})], null),view], null);
});
/**
...
var and__4221__auto__ = cljs.core.empty_QMARK_(path);
if(and__4221__auto__){
var and__4221__auto____$1 = new cljs.core.Keyword("nextjournal","navigable?","nextjournal/navigable?",-2104170780).cljs$core$IFn$_invoke$arity$1(options);
...
return (function (type,p__61870,coll){
var map__61871 = p__61870;
var map__61871__$1 = cljs.core.__destructure_map(map__61871);
var options = map__61871__$1;
var expanded = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61871__$1,new cljs.core.Keyword(null,"expanded","expanded",-3020742));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61871__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
var items = (function (){var G__61877 = coll;
if(cljs.core.object_QMARK_(coll)){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(G__61877);
} else {
return G__61877;
}
})();
...
var map_like_QMARK_ = (function (){var G__61878 = type;
...
var vec__61872 = nextjournal.viewer.coll_decoration(type);
var open = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61872,(0),null);
var close = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61872,(1),null);
...
})], null)),((((cljs.core.empty_QMARK_(items)) || (short_QMARK_)))?null:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.disclose","div.disclose",-1582817702),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(expanded_QMARK_)?null:"collapsed")], null)], null)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227),(function (){var G__61904 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61904__$1)].join('')));

}
})()], null),(cljs.core.truth_((function (){var or__4223__auto__ = cljs.core.not(map_like_QMARK_);
if(or__4223__auto__){
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(expanded_QMARK_)?new cljs.core.Keyword(null,"div.result-data-field","div.result-data-field",-311480386):new cljs.core.Keyword(null,"span","span",1394872991)),(cljs.core.truth_((function (){var or__4223__auto__ = expanded_QMARK_;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return map_like_QMARK_;
}
})())?(function (){var item__$1 = (cljs.core.truth_((function (){var or__4223__auto__ = map_like_QMARK_;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var G__61916 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(map_like_QMARK_)?"cmt-atom":"cmt-number")], null),(cljs.core.truth_(map_like_QMARK_)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.update.cljs$core$IFn$_invoke$arity$4(options,new cljs.core.Keyword(null,"path","path",-188191168),cljs.core.conj,i),item__$1], null):i),": "], null);
if(cljs.core.truth_(nextjournal.viewer.navigable_item_QMARK_(options,path,item__$1))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.browsify_button,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("nav","path","nav/path",-188053725).cljs$core$IFn$_invoke$arity$1(options),item__$1),options], null),G__61916);
} else {
return G__61916;
}
})():null),(function (){var item__$1 = ((cljs.core.map_QMARK_(coll))?cljs.core.get.cljs$core$IFn$_invoke$arity$2(coll,item):((cljs.core.object_QMARK_(coll))?goog.object.get(coll,item):item
));
...
try{var v = (function (){var obj61919 = obj;
if((!((obj61919 == null)))){
return (obj61919[applied_science.js_interop.impl.wrap_key(k)]);
} else {
return undefined;
}
})();
...
var visible_nb_items = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((20));
return (function (inspect,p__61920,obj){
var map__61921 = p__61920;
var map__61921__$1 = cljs.core.__destructure_map(map__61921);
var options = map__61921__$1;
var expanded = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61921__$1,new cljs.core.Keyword(null,"expanded","expanded",-3020742));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61921__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var expanded_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(expanded),path);
var parent = cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$1(path));
var short_QMARK_ = ((cljs.core.seq(path)) && (cljs.core.not(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(expanded),parent))));
var empty_QMARK_ = goog.object.isEmpty(obj);
...
})], null)),(cljs.core.truth_((function (){var or__4223__auto__ = empty_QMARK_;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return short_QMARK_;
}
})())?null:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.disclose","div.disclose",-1582817702),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(expanded_QMARK_)?null:"collapsed")], null)], null)),(cljs.core.truth_(t)?t.name:"Object")], null),((short_QMARK_)?null:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227)," {"], null)),(cljs.core.truth_((function (){var or__4223__auto__ = empty_QMARK_;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return short_QMARK_;
}
})())?null:(function (){var iter__4622__auto__ = (function nextjournal$viewer$inspect_object_$_iter__61922(s__61923){
return (new cljs.core.LazySeq(null,(function (){
var s__61923__$1 = s__61923;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__61923__$1);
if(temp__5753__auto__){
var s__61923__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61923__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__61923__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__61925 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__61924 = (0);
while(true){
if((i__61924 < size__4621__auto__)){
var k = cljs.core._nth(c__4620__auto__,i__61924);
if(cljs.core.truth_((function (){var or__4223__auto__ = cljs.core.not(t);
if(or__4223__auto__){
return or__4223__auto__;
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61925),nextjournal$viewer$inspect_object_$_iter__61922(cljs.core.chunk_rest(s__61923__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61925),null);
}
} else {
var k = cljs.core.first(s__61923__$2);
if(cljs.core.truth_((function (){var or__4223__auto__ = cljs.core.not(t);
if(or__4223__auto__){
return or__4223__auto__;
} else {
...
return iter__4622__auto__(cljs.core.take.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(visible_nb_items),items));
})()),((((cljs.core.not((function (){var or__4223__auto__ = empty_QMARK_;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return short_QMARK_;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.meta(data),new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947),(function (){var G__61946 = data;
...
return cljs.core.with_meta(G__61946,cljs.core.PersistentArrayMap.EMPTY);
} else {
return G__61946;
}
})());
...
var len__4829__auto___62186 = arguments.length;
var i__4830__auto___62187 = (0);
while(true){
if((i__4830__auto___62187 < len__4829__auto___62186)){
args__4835__auto__.push((arguments[i__4830__auto___62187]));

var G__62188 = (i__4830__auto___62187 + (1));
i__4830__auto___62187 = G__62188;
continue;
} else {
}
break;
...
return nextjournal.viewer.vary_meta.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4836__auto__);
});
...
/** @this {Function} */
(nextjournal.viewer.vary_meta.cljs$lang$applyTo = (function (seq61953){
var G__61954 = cljs.core.first(seq61953);
var seq61953__$1 = cljs.core.next(seq61953);
var G__61955 = cljs.core.first(seq61953__$1);
var seq61953__$2 = cljs.core.next(seq61953__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61954,G__61955,seq61953__$2);
}));
...
if(cljs.core.truth_((function (){var obj61965 = v;
if((!((obj61965 == null)))){
return (obj61965["parentNode"]);
} else {
return undefined;
}
})())){
...
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"reagent","reagent",2131627322),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__61963_SHARP_){
if(cljs.core.truth_(p1__61963_SHARP_)){
var temp__5753__auto___62195 = p1__61963_SHARP_.firstChild;
if(cljs.core.truth_(temp__5753__auto___62195)){
var childElement_62196 = temp__5753__auto___62195;
p1__61963_SHARP_.removeChild(childElement_62196);
} else {
}

return p1__61963_SHARP_.appendChild(v);
} else {
return null;
}
})], null)], null));
...
}),(function (p1__61962_SHARP_){
return reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(p1__61962_SHARP_);
}),nextjournal.viewer.plotly.viewer,nextjournal.viewer.code.viewer,nextjournal.viewer.mathjax.viewer,(function (p1__61964_SHARP_){
return reagent.core.as_element.cljs$core$IFn$_invoke$arity$1((function (){var G__61966 = p1__61964_SHARP_;
if(cljs.core.fn_QMARK_(p1__61964_SHARP_)){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__61966],null));
} else {
return G__61966;
}
})());
...
var fexpr__61972 = (((viewer instanceof cljs.core.Keyword))?(function (){var or__4223__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal","viewers","nextjournal/viewers",1064728841),viewer], null));
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
var or__4223__auto____$1 = (function (){var fexpr__61973 = cljs.core.deref(nextjournal.viewer._BANG_viewers);
return (fexpr__61973.cljs$core$IFn$_invoke$arity$1 ? fexpr__61973.cljs$core$IFn$_invoke$arity$1(viewer) : fexpr__61973.call(null,viewer));
})();
if(cljs.core.truth_(or__4223__auto____$1)){
return or__4223__auto____$1;
} else {
var or__4223__auto____$2 = cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"viewer-not-found","viewer-not-found",2084437371),viewer], 0));
...
return (fexpr__61972.cljs$core$IFn$_invoke$arity$2 ? fexpr__61972.cljs$core$IFn$_invoke$arity$2(value,options) : fexpr__61972.call(null,value,options));
});
...
var map__61976 = (function (){var G__61978 = options;
if(cljs.core.not(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(options))){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__61978,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",-188191168),cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword(null,"expanded","expanded",-3020742),reagent.core.state_atom(reagent.core.current_component())], null)], 0));
} else {
return G__61978;
}
})();
var map__61976__$1 = cljs.core.__destructure_map(map__61976);
var options__$1 = map__61976__$1;
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61976__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var expanded = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61976__$1,new cljs.core.Keyword(null,"expanded","expanded",-3020742));
var map__61977 = nextjournal.viewer.meta(data);
var map__61977__$1 = cljs.core.__destructure_map(map__61977);
var value_meta = map__61977__$1;
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61977__$1,new cljs.core.Keyword("nextjournal","value","nextjournal/value",-1912768947));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61977__$1,new cljs.core.Keyword("nextjournal","tag","nextjournal/tag",1515661557));
...
var viewer = (function (){var or__4223__auto__ = ((((cljs.core.fn_QMARK_(viewer_key)) || (cljs.core.list_QMARK_(viewer_key))))?viewer_key:null);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
var or__4223__auto____$1 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(options__$2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal","viewers","nextjournal/viewers",1064728841),viewer_key], null));
if(cljs.core.truth_(or__4223__auto____$1)){
return or__4223__auto____$1;
} else {
var fexpr__61979 = cljs.core.deref(nextjournal.viewer._BANG_viewers);
return (fexpr__61979.cljs$core$IFn$_invoke$arity$1 ? fexpr__61979.cljs$core$IFn$_invoke$arity$1(viewer_key) : fexpr__61979.call(null,viewer_key));
}
}
})();
...
var G__61986 = value;
if(cljs.core.seq(m)){
return nextjournal.viewer.vary_meta.cljs$core$IFn$_invoke$arity$variadic(G__61986,cljs.core.merge,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m], 0));
} else {
return G__61986;
}
})()], null)], null);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (){var G__62015 = nextjournal.viewer.inspect;
...
return cljs.core.partial.cljs$core$IFn$_invoke$arity$2(G__62015,nextjournal.viewer.meta(x));
} else {
return G__62015;
}
})());
...
var evolve = (function (p1__62017_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(rule30,cljs.core.partition.cljs$core$IFn$_invoke$arity$4((3),(1),cljs.core.repeat.cljs$core$IFn$_invoke$arity$1((0)),cljs.core.cons((0),p1__62017_SHARP_)));
});
...
return (function (state){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.result-data","div.result-data",-1539734720),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,nextjournal.viewer.with_viewers(nextjournal.viewer.with_viewer(cljs.core.deref(state),new cljs.core.Keyword(null,"board","board",-1907017633)),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"cell","cell",764245084),(function (p1__62023_SHARP_){
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.inline-block","div.inline-block",-502349916),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(((p1__62023_SHARP_ === (0)))?"bg-white border-solid border-2 border-black":"bg-black"),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(16),new cljs.core.Keyword(null,"height","height",1025178622),(16)], null)], null)], null));
}),new cljs.core.Keyword(null,"row","row",-570139521),(function (x,options){
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.inline-flex","div.flex.inline-flex",1792928195)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62024_SHARP_){
return nextjournal.viewer.inspect.cljs$core$IFn$_invoke$arity$2(options,nextjournal.viewer.view_as(new cljs.core.Keyword(null,"cell","cell",764245084),p1__62024_SHARP_));
}),x)));
}),new cljs.core.Keyword(null,"board","board",-1907017633),(function (x,options){
return nextjournal.viewer.view_as(new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-col","div.flex.flex-col",255067761)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62025_SHARP_){
return nextjournal.viewer.inspect.cljs$core$IFn$_invoke$arity$2(options,nextjournal.viewer.view_as(new cljs.core.Keyword(null,"row","row",-570139521),p1__62025_SHARP_));
}),x)));
})], null))], null)], null);
});
...
var cell = (function (p1__62044_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"div.inline-block","div.inline-block",-502349916),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),(((p1__62044_SHARP_ === (0)))?"bg-white border-solid border-2 border-black":"bg-black"),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(16),new cljs.core.Keyword(null,"height","height",1025178622),(16)], null)], null)],null));
});
var row = (function (p1__62045_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.inline-flex","div.flex.inline-flex",1792928195)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$1(cell),p1__62045_SHARP_);
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,nextjournal.viewer.with_viewer(cljs.core.list(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(1),(0)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(0),(1)], null)),cljs.core.list(new cljs.core.Symbol(null,"fn","fn",465265323,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"board","board",-266486106,null)], null),cljs.core.list(new cljs.core.Symbol(null,"let","let",358118826,null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"cell","cell",-1890190685,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__62047#","p1__62047#",2048640920,null)], null),cljs.core.list(new cljs.core.Symbol(null,"vector","vector",-751469611,null),new cljs.core.Keyword(null,"div.inline-block","div.inline-block",-502349916),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.list(new cljs.core.Symbol(null,"if","if",1181717262,null),cljs.core.list(new cljs.core.Symbol(null,"zero?","zero?",325758897,null),new cljs.core.Symbol(null,"p1__62047#","p1__62047#",2048640920,null)),"bg-white border-solid border-2 border-black","bg-black"),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),(16),new cljs.core.Keyword(null,"height","height",1025178622),(16)], null)], null))),new cljs.core.Symbol(null,"row","row",1070392006,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__62048#","p1__62048#",-123388738,null)], null),cljs.core.list(new cljs.core.Symbol(null,"into","into",1489695498,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.inline-flex","div.flex.inline-flex",1792928195)], null),cljs.core.list(new cljs.core.Symbol(null,"map","map",-1282745308,null),new cljs.core.Symbol(null,"cell","cell",-1890190685,null)),new cljs.core.Symbol(null,"p1__62048#","p1__62048#",-123388738,null)))], null),cljs.core.list(new cljs.core.Symbol("v","html","v/html",641734256,null),cljs.core.list(new cljs.core.Symbol(null,"into","into",1489695498,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-col","div.flex.flex-col",255067761)], null),cljs.core.list(new cljs.core.Symbol(null,"map","map",-1282745308,null),new cljs.core.Symbol(null,"row","row",1070392006,null)),new cljs.core.Symbol(null,"board","board",-266486106,null))))))], null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__4622__auto__ = (function nextjournal$viewer$iter__62053(s__62054){
return (new cljs.core.LazySeq(null,(function (){
var s__62054__$1 = s__62054;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__62054__$1);
if(temp__5753__auto__){
var s__62054__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__62054__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__62054__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__62056 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__62055 = (0);
while(true){
if((i__62055 < size__4621__auto__)){
var value = cljs.core._nth(c__4620__auto__,i__62055);
cljs.core.chunk_append(b__62056,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer","div.mb-3.result-viewer",896613001),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value","code.inspected-value",521789178),(function (){var _STAR_print_meta_STAR__orig_val__62064 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__62065 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__62065);
...
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__62064);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62056),nextjournal$viewer$iter__62053(cljs.core.chunk_rest(s__62054__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62056),null);
}
} else {
var value = cljs.core.first(s__62054__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer","div.mb-3.result-viewer",896613001),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value","code.inspected-value",521789178),(function (){var _STAR_print_meta_STAR__orig_val__62068 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__62071 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__62071);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([value], 0));
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__62068);
}})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227)," => "], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.PersistentArrayMap.EMPTY,value], null)], null),nextjournal$viewer$iter__62053(cljs.core.rest(s__62054__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.p-6","div.p-6",1412057822)], null),(function (){var iter__4622__auto__ = (function nextjournal$viewer$iter__62074(s__62075){
return (new cljs.core.LazySeq(null,(function (){
var s__62075__$1 = s__62075;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__62075__$1);
if(temp__5753__auto__){
var s__62075__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__62075__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__62075__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__62077 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__62076 = (0);
while(true){
if((i__62076 < size__4621__auto__)){
var value = cljs.core._nth(c__4620__auto__,i__62076);
cljs.core.chunk_append(b__62077,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer.dark:text-slate-300","div.mb-3.result-viewer.dark:text-slate-300",-1022028343),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value.dark:bg-transparent.dark:text-slate-300","code.inspected-value.dark:bg-transparent.dark:text-slate-300",1787800450),(function (){var _STAR_print_meta_STAR__orig_val__62084 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__62085 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__62085);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([value], 0));
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__62084);
}})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227)," => "], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.PersistentArrayMap.EMPTY,value], null)], null));

var G__62246 = (i__62076 + (1));
i__62076 = G__62246;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__62077),nextjournal$viewer$iter__62074(cljs.core.chunk_rest(s__62075__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__62077),null);
}
} else {
var value = cljs.core.first(s__62075__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mb-3.result-viewer.dark:text-slate-300","div.mb-3.result-viewer.dark:text-slate-300",-1022028343),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"code.inspected-value.dark:bg-transparent.dark:text-slate-300","code.inspected-value.dark:bg-transparent.dark:text-slate-300",1787800450),(function (){var _STAR_print_meta_STAR__orig_val__62086 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__62087 = true;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__62087);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([value], 0));
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__62086);
}})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.inspected-value","span.inspected-value",175758227)," => "], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [nextjournal.viewer.inspect,cljs.core.PersistentArrayMap.EMPTY,value], null)], null),nextjournal$viewer$iter__62074(cljs.core.rest(s__62075__$2)));
}
} else {
return null;
}
...
return (function (state){
var map__62091 = cljs.core.deref(state);
var map__62091__$1 = cljs.core.__destructure_map(map__62091);
var clj = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62091__$1,new cljs.core.Keyword(null,"clj","clj",-660495428));
var clj_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62091__$1,new cljs.core.Keyword(null,"clj-map","clj-map",-730949109));
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62091__$1,new cljs.core.Keyword(null,"js","js",1768080579));
...
var G__62270 = (x__$1 - (1));
var G__62271 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(res,gen_keyword(),(val_fun.cljs$core$IFn$_invoke$arity$0 ? val_fun.cljs$core$IFn$_invoke$arity$0() : val_fun.call(null)));
x__$1 = G__62270;
res = G__62271;
continue;
...
var with_let62116 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let62116","with-let62116",2136467578));
var temp__5757__auto___62272 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5757__auto___62272 == null)){
} else {
var c__57349__auto___62273 = temp__5757__auto___62272;
if((with_let62116.generation === c__57349__auto___62273.ratomGeneration)){
