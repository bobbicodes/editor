...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_46212 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_46212(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_46220 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_46220(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46221 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_46221(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46224 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_46224(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46225 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_46225(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46226 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_46226(reader);
}
});
...
var G__46275 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__46276 = s.append(c);
c = G__46275;
s = G__46276;
continue;
}
