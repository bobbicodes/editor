...
var i_50656 = (0);
while(true){
if((i_50656 < arr.length)){
(arr[i_50656] = null);

var G__50657 = (i_50656 + (1));
i_50656 = G__50657;
continue;
} else {
}
...
var i_50664 = (self__.level + (1));
while(true){
if((i_50664 <= (new_level + (1)))){
(update[i_50664] = self__.header);

var G__50665 = (i_50664 + (1));
i_50664 = G__50665;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_50666 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_50666[i]));
} else {
x__$2.forward.push((((i < links_50666.length))?(links_50666[i]):null));
}

if((i < links_50666.length)){
(links_50666[i] = x__$2);
} else {
links_50666.push(x__$2);
}
...
var i_50672 = (0);
while(true){
if((i_50672 <= self__.level)){
var links_50673 = (update[i_50672]).forward;
if((x__$1 === (((i_50672 < links_50673.length))?(links_50673[i_50672]):null))){
(links_50673[i_50672] = (x__$1.forward[i_50672]));

var G__50674 = (i_50672 + (1));
i_50672 = G__50674;
continue;
} else {
var G__50675 = (i_50672 + (1));
i_50672 = G__50675;
continue;
}
} else {
...
var G__50677 = nx;
var G__50678 = (level__$1 - (1));
x = G__50677;
level__$1 = G__50678;
continue;
} else {
var G__50679 = x;
var G__50680 = (level__$1 - (1));
x = G__50679;
level__$1 = G__50680;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__50682 = nx;
var G__50683 = (level__$1 - (1));
x = G__50682;
level__$1 = G__50683;
continue;
} else {
var G__50684 = x;
var G__50685 = (level__$1 - (1));
x = G__50684;
level__$1 = G__50685;
continue;
}
