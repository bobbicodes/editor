...
return [(function (){var pred__58654 = cljs.core.instance_QMARK_;
var expr__58655 = reactive_val;
if(cljs.core.truth_((pred__58654.cljs$core$IFn$_invoke$arity$2 ? pred__58654.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__58655) : pred__58654.call(null,reagent.ratom.RAtom,expr__58655)))){
return "ra";
} else {
if(cljs.core.truth_((pred__58654.cljs$core$IFn$_invoke$arity$2 ? pred__58654.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__58655) : pred__58654.call(null,reagent.ratom.RCursor,expr__58655)))){
return "rc";
} else {
if(cljs.core.truth_((pred__58654.cljs$core$IFn$_invoke$arity$2 ? pred__58654.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__58655) : pred__58654.call(null,reagent.ratom.Reaction,expr__58655)))){
return "rx";
} else {
if(cljs.core.truth_((pred__58654.cljs$core$IFn$_invoke$arity$2 ? pred__58654.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__58655) : pred__58654.call(null,reagent.ratom.Track,expr__58655)))){
return "tr";
} else {
return "other";
}
...
var _STAR_in_batch_QMARK__STAR__orig_val__58660 = re_frame.interop._STAR_in_batch_QMARK__STAR_;
var _STAR_in_batch_QMARK__STAR__temp_val__58662 = true;
(re_frame.interop._STAR_in_batch_QMARK__STAR_ = _STAR_in_batch_QMARK__STAR__temp_val__58662);

try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {(re_frame.interop._STAR_in_batch_QMARK__STAR_ = _STAR_in_batch_QMARK__STAR__orig_val__58660);
}}));
});
var flush_queues_58676 = reagent.impl.batching.render_queue.flush_queues.bind(reagent.impl.batching.render_queue);
(reagent.impl.batching.render_queue.flush_queues = (function (){
return re_frame.interop.batch_updates(flush_queues_58676);
}));
var queue_render_58678 = reagent.impl.batching.queue_render;
(reagent.impl.batching.queue_render = (function (c){
if(cljs.core.truth_(re_frame.interop._STAR_in_batch_QMARK__STAR_)){
return c.forceUpdate();
} else {
return (queue_render_58678.cljs$core$IFn$_invoke$arity$1 ? queue_render_58678.cljs$core$IFn$_invoke$arity$1(c) : queue_render_58678.call(null,c));
}
}));
