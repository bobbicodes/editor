...
var map__62122 = cljs.core.meta(iobj);
var map__62122__$1 = cljs.core.__destructure_map(map__62122);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62122__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62122__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__62122__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.vars.current_file));
...
var st = (function (){var or__4223__auto__ = (function (){var temp__5753__auto__ = new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(d);
...
var map__62129 = (function (){var or__4223__auto__ = stack;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
var G__62130 = env;
var G__62130__$1 = (((G__62130 == null))?null:cljs.core.deref(G__62130));
var G__62130__$2 = (((G__62130__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__62130__$1));
var G__62130__$3 = (((G__62130__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__62130__$2,id));
var G__62130__$4 = (((G__62130__$3 == null))?null:cljs.core.deref(G__62130__$3));
var G__62130__$5 = (((G__62130__$4 == null))?null:cljs.core.last(G__62130__$4));
if((G__62130__$5 == null)){
return null;
} else {
return cljs.core.meta(G__62130__$5);
}
}
})();
var map__62129__$1 = cljs.core.__destructure_map(map__62129);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62129__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62129__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62129__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var and__4221__auto__ = (((!((obj == null))))?(((((obj.cljs$lang$protocol_mask$partition0$ & (262144))) || ((cljs.core.PROTOCOL_SENTINEL === obj.cljs$core$IWithMeta$))))?true:false):false);
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq62146){
var G__62147 = cljs.core.first(seq62146);
var seq62146__$1 = cljs.core.next(seq62146);
var G__62148 = cljs.core.first(seq62146__$1);
var seq62146__$2 = cljs.core.next(seq62146__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62147,G__62148,seq62146__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__62151 = cljs.core.namespace(sym);
switch (G__62151) {
case "clojure.core":
case "cljs.core":
...
return (new cljs.core.MapEntry((function (){var G__62155 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__62155) : inner.call(null,G__62155));
})(),(function (){var G__62156 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__62156) : inner.call(null,G__62156));
})(),null));
} else {
...
var fexpr__62169 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__62169.cljs$core$IFn$_invoke$arity$2 ? fexpr__62169.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__62169.call(null,sci_ctx,form));
});
/**
...
var run = cljs.core.cons(fst,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__62171_SHARP_){
return f(p1__62171_SHARP_);
}),cljs.core.next(s)));
return cljs.core.cons(run,(function (){var G__62175 = pred;
var G__62176 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__62175,G__62176) : sci.impl.utils.split_when.call(null,G__62175,G__62176));
})());
} else {
return null;
}
...
var G__62233 = cljs.core.next(params__$1);
var G__62234 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__62235 = lets;
params__$1 = G__62233;
new_params = G__62234;
lets = G__62235;
...
var G__62236 = cljs.core.next(params__$1);
var G__62237 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__62238 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__62236;
new_params = G__62237;
lets = G__62238;
continue;
...
var G__62197 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.vars.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.vars.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62197,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__62197;
}
}));
...
return sci.impl.utils.log.cljs$core$IFn$_invoke$arity$variadic(argseq__4836__auto__);
});
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq62198){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq62198));
}));
