...
nextjournal.devcards.register_devcard_STAR_ = (function nextjournal$devcards$register_devcard_STAR_(p__60200){
var map__60201 = p__60200;
var map__60201__$1 = cljs.core.__destructure_map(map__60201);
var opts = map__60201__$1;
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60201__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60201__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var trace = (function (){var G__60203 = info;
var G__60203__$1 = (((G__60203 == null))?null:G__60203.componentStack);
var G__60203__$2 = (((G__60203__$1 == null))?null:clojure.string.split.cljs$core$IFn$_invoke$arity$2(G__60203__$1,"\n"));
if((G__60203__$2 == null)){
return null;
} else {
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.empty_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.string.trim,G__60203__$2)));
}
})();
...
var vec__60204 = temp__5751__auto__;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60204,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60204,(1),null);
...
nextjournal.devcards.testview = reagent.core.create_class.cljs$core$IFn$_invoke$arity$1(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"render","render",-1408033454),nextjournal.view.wrap_render((function nextjournal$devcards$testview(p__60207){
var map__60208 = p__60207;
var map__60208__$1 = cljs.core.__destructure_map(map__60208);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60208__$1,new cljs.core.Keyword("nextjournal.view","state","nextjournal.view/state",-1424072930));
...
nextjournal.devcards.testc = reagent.core.create_class.cljs$core$IFn$_invoke$arity$1(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"render","render",-1408033454),nextjournal.view.wrap_render((function nextjournal$devcards$testc(p__60209){
var map__60210 = p__60209;
var map__60210__$1 = cljs.core.__destructure_map(map__60210);
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60210__$1,new cljs.core.Keyword("re-frame.context","dispatch","re-frame.context/dispatch",1850204165));
var subscribe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60210__$1,new cljs.core.Keyword("re-frame.context","subscribe","re-frame.context/subscribe",-119266480));
...
var G__60211 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal.devcards","inc","nextjournal.devcards/inc",1768266442)], null);
return (dispatch.cljs$core$IFn$_invoke$arity$1 ? dispatch.cljs$core$IFn$_invoke$arity$1(G__60211) : dispatch.call(null,G__60211));
})], null),"Counter = ",cljs.core.deref((function (){var G__60212 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("nextjournal.devcards","counter","nextjournal.devcards/counter",1209240473)], null);
return (subscribe.cljs$core$IFn$_invoke$arity$1 ? subscribe.cljs$core$IFn$_invoke$arity$1(G__60212) : subscribe.call(null,G__60212));
})())], null);
...
nextjournal.devcards.frame_display = reagent.core.create_class.cljs$core$IFn$_invoke$arity$1(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"render","render",-1408033454),nextjournal.view.wrap_render((function nextjournal$devcards$frame_display(p__60213){
var map__60214 = p__60213;
var map__60214__$1 = cljs.core.__destructure_map(map__60214);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60214__$1,new cljs.core.Keyword("nextjournal.view","state","nextjournal.view/state",-1424072930));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frame.context.provide_frame,frame,(function (){var _STAR_current_frame_STAR__orig_val__60215 = re_frame.registry._STAR_current_frame_STAR_;
var _STAR_current_frame_STAR__temp_val__60216 = frame;
(re_frame.registry._STAR_current_frame_STAR_ = _STAR_current_frame_STAR__temp_val__60216);
...
}finally {(re_frame.registry._STAR_current_frame_STAR_ = _STAR_current_frame_STAR__orig_val__60215);
}})()], null);
